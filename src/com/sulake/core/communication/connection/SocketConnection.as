package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      private var var_467:ByteArray;
      
      private var var_1037:IEncryption;
      
      private var var_679:IProtocol;
      
      private var _id:String;
      
      private var var_1038:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_278 = param2;
         this.var_467 = new ByteArray();
         this.var_1038 = new MessageClassManager();
         this.var_73 = new Socket();
         this.var_318 = new Timer(const_1258,1);
         this.var_318.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1038.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_679.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_468)
         {
         ...
         {
            _loc3_ = this.var_1037.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1038.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_679.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_679.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1037 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_679.getMessages(this.var_467,receivedMessages);
         ...
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1038.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_467,offset);
               this.var_467 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_467.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_467.writeByte(this.var_73.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_318.stop();
         this.var_1633 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_680));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1633 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_680));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_680));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_680));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_680));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_680));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_318.delay + " ms). Possible Firewall.";
