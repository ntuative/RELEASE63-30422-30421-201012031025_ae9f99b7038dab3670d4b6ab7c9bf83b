package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_423:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_423 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_113 is BitmapDataAsset)
         {
            ...
            this.var_1374 = BitmapDataAsset(this.var_113).var_1374;
            this.var_1375 = BitmapDataAsset(this.var_113).var_1375;
            if(this._bitmap != null)
            {
               this.var_113 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1374 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1375 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
