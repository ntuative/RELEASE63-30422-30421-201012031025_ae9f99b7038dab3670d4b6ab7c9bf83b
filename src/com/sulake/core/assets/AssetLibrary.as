package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1066:String = "AssetLibraryReady";
      
      public static const const_699:String = "AssetLibraryLoaded";
      
      public static const const_1347:String = "AssetLibraryUnloaded";
      
      public static const const_1503:String = "AssetLibraryLoadError";
      
      private static var var_280:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_491:uint = 0;
      
      private static var var_897:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_491;
         this.var_403 = new Dictionary(false);
         this.var_492 = new Dictionary(false);
         this.var_895 = new Dictionary(false);
         this.var_148 = new Dictionary(false);
         var_897.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_897.splice(var_897.indexOf(this),1);
            --var_491;
            this.var_492 = null;
            this.var_895 = null;
            this.var_148 = null;
      ...
      {
         if(this._file == param1.url && this.var_896)
         {
            if(!this.var_894 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_739,this.var_610);
            }
            this.var_894 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1066));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_492)
         {
            _loc2_ = this.var_492[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_492[_loc1_];
         }
         for(_loc1_ in this.var_148)
         {
            delete this.var_148[_loc1_];
         }
         for(_loc1_ in this.var_895)
         {
            delete this.var_895[_loc1_];
         }
         if(this.var_38 != null)
         {
            this.var_38.dispose();
         ...
         this.var_896 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1347));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_895[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_492[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_883,this.assetLoadEventHandler);
         ...
         this.var_492[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_492[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_148[struct.assetName] == null)
                  {
                     ++this.var_404;
                     this.var_402.push(struct.assetName);
                  }
                  this.var_148[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_42,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_492[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_148[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_402.length ? this.getAssetByName(this.var_402[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_148)
         {
            if(this.var_148[_loc2_] == param1)
            {
               return this.var_402.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_148[param1] != null || (this.var_610 != null ? this.var_610[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_148[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_280.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_280[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_403.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_403[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_280[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_403[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_280)
            {
               _loc3_ = AssetTypeDeclaration(var_280[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_403)
         {
            _loc3_ = AssetTypeDeclaration(this.var_403[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_280)
            {
               _loc4_ = AssetTypeDeclaration(var_280[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_403)
         {
            _loc4_ = AssetTypeDeclaration(this.var_403[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_896 = true;
         dispatchEvent(new Event(AssetLibrary.const_699));
         dispatchEvent(new Event(AssetLibrary.const_1066));
         if(this.var_894)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1503));
         this.var_38 = null;
      }
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_610[param1]);
