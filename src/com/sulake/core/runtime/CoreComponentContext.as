package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1125:String = "asset-libraries";
      
      private static const const_1126:String = "library";
      
      private static const const_1130:String = "service-libraries";
      
      private static const const_1128:String = "library";
      
      private static const const_1127:String = "component-libraries";
      ...
      private var var_632:IEventDispatcher;
      
      private var var_427:uint;
      
      private var var_429:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         this.var_1458 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_411.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1032:
               debug("Core; using simple frame update handler");
               this.var_429 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_626:
               debug("Core; using complex frame update handler");
               this.var_429 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1408:
               debug("Core; using profiler frame update handler");
               this.var_429 = this.profilerFrameUpdateHandler;
               this.var_217 = new Profiler(this);
               attachComponent(this.var_217,[new IIDProfiler()]);
               var_411.addChild(new ProfilerViewer(this.var_217));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_429 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_427 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_411.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_411 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_140)
            {
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_632 = loadingEventDelegate;
         if(this.var_293 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_293,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_293,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_293,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1285);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_632)
         {
            this.var_632.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_632)
         {
            ...
            this.var_632.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_632)
                  {
                     this.var_632.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_427 - this.var_293.length,this.var_427,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_429(_loc2_,_loc2_ - this.var_1458);
         this.var_1458 = _loc2_;
      }
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_411.stage.frameRate;
         criticality = 0;
         while(criticality < CoreComponentContext.const_140)
         {
            t = getTimer();
            ...
            {
               if(this.var_521[criticality] < criticality)
               {
                  ++this.var_521[criticality];
                  skip = true;
               }
            }
            if(!skip)
