   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(param2.type == WindowNotifyEvent.const_437)
         {
            ...
            this.var_1012 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_13 != this._scrollBar)
            {
               this._scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_270,this,null));
            }
         }
