package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_381:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1114:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1115:String = "item_array";
      ...
      private var var_160:DropMenuController;
      ...
      {
         if(this.var_160 != null && !this.var_160.disposed)
         {
            this.var_160.destroy();
            this.var_160 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_381) as ITextWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_160 == null || this.var_160.disposed)
         {
            this.var_160 = context.create(name + "::submenu","",WindowType.const_457,var_78,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_160.setGlobalRectangle(_loc1_);
         }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1114) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_160.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_857 = false;
            this.getTitleText().text = this.var_594 < this._itemArray.length && this.var_594 > -1 ? this._itemArray[this.var_594] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1114) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_464,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_348,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_594 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_594).setStateFlag(WindowState.const_47,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_39 || param1.type == WindowTouchEvent.const_401)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1051:
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1115,this._itemArray,PropertyStruct.const_145,this._itemArray.length > 0));
         return _loc1_;
      }
