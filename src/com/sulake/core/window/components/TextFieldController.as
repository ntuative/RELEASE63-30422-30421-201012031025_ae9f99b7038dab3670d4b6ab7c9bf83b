package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1165 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_882,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_401)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_343,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1151,PropertyStruct.const_50,this.var_1151 != false));
         return _loc1_;
      }
