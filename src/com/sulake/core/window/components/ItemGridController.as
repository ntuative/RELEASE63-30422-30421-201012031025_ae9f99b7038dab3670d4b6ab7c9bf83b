package com.sulake.core.window.components
{
   ...
   public class ItemGridController extends ItemListController implements IItemGridWindow
   {
      ...
      {
         var _loc2_:IItemListWindow = var_16.create(_name + "_COLUMN_" + numListItems,null,WindowType.const_355,WindowStyle.const_606,0 | 0,new Rectangle(0,0,Math.max(param1.width,0),Math.max(param1.height,0)),this.listEventProc,null,numListItems,null,[WindowController.TAG_INTERNAL,WindowController.TAG_EXCLUDE]) as IItemListWindow;
