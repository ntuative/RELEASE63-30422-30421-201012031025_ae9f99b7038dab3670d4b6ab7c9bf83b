package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1159:String = "_TITLE";
      
      private static const const_1161:String = "_HEADER";
      
      private static const const_1160:String = "_CONTENT";
      
      private static const const_1158:String = "_SCALER";
      
      private static const const_839:String = "margin_left";
      
      private static const const_838:String = "margin_top";
      
      private static const const_837:String = "margin_right";
      
      private static const const_836:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1244:IHeaderWindow;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1159) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1244 = findChildByTag(const_1161) as IHeaderWindow;
            if(!this.var_1244)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_157 = findChildByTag(const_1160) as IWindowContainer;
            if(!this.var_157)
            {
      ...
      {
         return findChildByTag(const_1158) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1117,_loc2_,false);
      ...
      {
         return this.content != null && this.var_928 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_839,_loc3_.left,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_838,_loc3_.top,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_837,0 - _loc3_.right,PropertyStruct.const_51,_loc2_));
         _loc1_.push(new PropertyStruct(const_836,0 - _loc3_.bottom,PropertyStruct.const_51,_loc2_));
         return _loc1_;
      }
