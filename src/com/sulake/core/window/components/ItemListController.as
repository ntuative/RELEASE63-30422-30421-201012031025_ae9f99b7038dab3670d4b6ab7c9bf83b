package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1110:String = "spacing";
      
      protected static const const_1111:String = "scale_to_fit_items";
      
      protected static const const_1108:String = "resize_on_item_update";
      
      protected static const const_1109:String = "auto_arrange_items";
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1509:Boolean = false;
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1508:Boolean = true;
      ...
      protected var var_1866:Boolean = false;
      ...
      protected var var_2644:Number = 0.0;
      
      protected var var_2645:Number = 0.0;
      
      protected var var_925:Boolean = true;
      
      protected var var_508:Boolean = false;
      
      protected var var_1156:Boolean = false;
      
      protected var var_1868:int = 0;
      
      protected var var_1867:int = 0;
      
      protected var var_1154:Number;
      
      protected var var_1155:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_99 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_351;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_150 = var_408 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_348,WindowStyle.const_606,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_44,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_536,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_281,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_436,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1156;
      }
      ...
      {
         return new Rectangle(this.var_619 * this.maxScrollH,this.var_620 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_619 = param1;
            this._container.x = -this.var_619 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_67);
            dispatchEvent(new WindowEvent(WindowEvent.const_440,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_620 = param1;
            this._container.y = -this.var_620 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_67);
            dispatchEvent(new WindowEvent(WindowEvent.const_440,this,null));
         }
      }
      ...
      {
         this.var_2644 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2645 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_433,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_536,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_281,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_39:
               this.var_1868 = _loc3_;
               this.var_1867 = _loc4_;
               this.var_1154 = 0;
               this.var_1155 = 0;
               this.var_1157 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_166:
               if(this.var_1157)
               {
                  this.var_1154 = this.var_1868 - _loc3_;
                  this.var_1155 = this.var_1867 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1154 != 0 && this.var_99 != 0)
                     {
                        this.scrollH += this.var_1154 / this.var_99;
                     }
                  }
                  else if(this.var_1155 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1155 / this.var_90;
                  }
                  this.var_1868 = _loc3_;
                  this.var_1867 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_174:
               if(this.var_1157)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1154,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1155);
                  }
                  this.var_1157 = false;
                  _loc2_ = true;
               }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case WindowEvent.const_536:
               this.updateScrollAreaRegion();
               break;
            case WindowEvent.const_281:
               if(!this.var_1866)
               {
                  this.updateScrollAreaRegion();
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_925 && !this.var_507 && this._container)
         {
            this.var_507 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1110,this._spacing,PropertyStruct.const_51,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1109,this.var_925,PropertyStruct.const_50,this.var_925 != const_1508));
         _loc1_.push(new PropertyStruct(const_1111,this.var_508,PropertyStruct.const_50,this.var_508 != const_1509));
         _loc1_.push(new PropertyStruct(const_1108,this.var_1156,PropertyStruct.const_50,this.var_1156 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1108:
                  ...
                  break;
               case const_1109:
                  this.var_925 = _loc2_.value as Boolean;
                  break;
            }
         }
