package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1522:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1118:String = "TAB_BUTTON_TITLE";
      
      private static const const_1521:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1118));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
