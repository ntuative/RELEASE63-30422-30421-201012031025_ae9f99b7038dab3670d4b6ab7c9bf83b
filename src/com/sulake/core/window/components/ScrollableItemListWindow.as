package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_380:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_69))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_380)
         {
            this.var_380.removeEventListener(WindowEvent.const_302,this.scrollBarEventProc);
            this.var_380.removeEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            this.var_380 = null;
         }
         if(this.var_1025)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1025)
         {
            this.var_1025 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_380)
         {
            this.var_380 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_380)
            {
               this.var_380.addEventListener(WindowEvent.const_302,this.scrollBarEventProc);
               this.var_380.addEventListener(WindowEvent.const_252,this.scrollBarEventProc);
            }
         }
         return this.var_380;
      }
      ...
      {
         if(param1.type == WindowEvent.const_302)
         {
            this.showScrollBar();
         }
