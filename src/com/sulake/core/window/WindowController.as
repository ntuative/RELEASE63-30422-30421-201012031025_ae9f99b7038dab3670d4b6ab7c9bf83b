package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1142:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1117:String = "_COLORIZE";
      
      protected static const const_1520:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1391:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_640 = _loc13_.blend;
            var_407 = _loc13_.treshold;
            if(var_408 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_214 != _loc13_.color)
            {
      ...
      {
         var_408 = param1;
         var_214 = !!var_408 ? uint(var_214 | var_505) : uint(var_214 & 16777215);
      ...
      {
         var_755 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_471,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_505 = param1 & 4278190080;
         var_214 = !!var_408 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_67);
      }
      ...
      {
         var_505 = param1 << 24;
         var_214 = !!var_408 ? uint(var_505 | var_214) : uint(16777215 & var_214);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_67);
      }
      
      public function set blend(param1:Number) : void
      {
         var_640 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_914);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_78 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_504,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_343 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_525,this,this.var_13));
            }
            else
            {
               this.var_343.x = 0;
               this.var_343.y = 0;
               this.var_343.width = 0;
               this.var_343.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_976,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_733,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_19,var_16,var_11,null,this.var_762,this.properties,var_754.concat(),_id) as WindowController;
         _loc2_.var_407 = var_407;
         _loc2_.var_150 = this.var_150;
         _loc2_._debug = this._debug;
         _loc2_.var_343 = this.var_343.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2560 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1008,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_596,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_437,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_168,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_129 != null)
         {
            param3.x = var_129.x;
            param3.y = var_129.y;
            param3.width = var_129.width;
            param3.height = var_129.height;
         }
         if(param4 != null && var_130 != null)
         {
            param4.x = var_130.x;
            param4.y = var_130.y;
            param4.width = var_130.width;
            param4.height = var_130.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_130.x = param3.x;
            var_130.y = param3.y;
            var_130.width = param3.width;
            var_130.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            var_129.x = param2.x;
            var_129.y = param2.y;
            var_129.width = param2.width;
            var_129.height = param2.height;
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_39:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1097;
                  if(testParamFlag(WindowParam.const_320))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_212))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_168:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_396,this,null));
                     if(testParamFlag(WindowParam.const_172,WindowParam.const_142))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_188,WindowParam.const_154))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
               ...
               case WindowNotifyEvent.const_437:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_411);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1056,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_270,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_331:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_755,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_235,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_460:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_902);
                  break;
               case WindowNotifyEvent.const_504:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1520) == -1)
                     {
                        _loc8_.style = var_78;
                     }
                  }
               ...
               case WindowNotifyEvent.const_471:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_411);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_396:
                  this.var_13.getRegionProperties(null,this.var_343);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_906:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1400:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1434:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1060:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_667:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_471:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_755:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_235:
               _loc2_ = "null";
         ...
         if(this.var_150 && var_407 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1391,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1391,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_142);
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_154);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_343.width;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.WINDOW_PARAM_RELATIVE_HORIZONTAL_SCALE_STRECH)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_366)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_343.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_368)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_359)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_477)
         {
            return true;
         }
         _state = WindowState.const_477;
         ...
         _loc1_.type = WindowNotifyEvent.const_1031;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1024,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1089,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1060,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_667;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1080;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1061,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1392 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_376,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1392 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_772,this,param1));
         return param1;
      }
