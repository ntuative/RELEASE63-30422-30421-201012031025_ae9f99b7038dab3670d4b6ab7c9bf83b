package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_408:Boolean = false;
      
      protected var var_214:uint = 16777215;
      
      protected var var_505:uint;
      
      protected var var_407:uint = 10;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_346 = param7.clone();
         this.var_56 = param7.clone();
         this.var_129 = new Rectangle();
         this.var_130 = null;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_477;
            this.var_754 = null;
         }
      }
      ...
      {
         return this.var_346.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_346.height;
      }
