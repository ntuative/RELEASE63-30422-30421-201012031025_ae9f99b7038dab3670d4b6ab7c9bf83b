package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1261:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1262:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_140:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_140 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1261() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_140)
         {
            this.var_140.removeStopEventListener(this.refresh);
            this.var_140 = null;
         }
         if(!this.var_140 && param1)
         {
            this.var_140 = param1;
            this.var_140.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_770)
            {
               this.var_1581 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_140.getProfilerAgentsInArray();
         ...
         if(this.var_1581)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_140.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_140.numBitmapAssetInstances + " / " + this.var_140.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_140.numTrackedBitmapDataInstances + " / " + this.var_140.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1262() as ByteArray;
