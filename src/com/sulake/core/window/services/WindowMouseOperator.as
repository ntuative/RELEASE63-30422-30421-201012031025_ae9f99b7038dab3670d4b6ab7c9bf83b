package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_617:Point;
      
      protected var var_1400:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_617);
         this._window.offset(this.var_617.x - this._offset.x,this.var_617.y - this._offset.y);
      }
