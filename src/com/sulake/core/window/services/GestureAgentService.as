package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_256:Function;
      
      protected var var_1149:int;
      
      protected var var_1150:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1149 *= 0.75;
         this.var_1150 *= 0.75;
         if(Math.abs(this.var_1149) <= 1 && Math.abs(this.var_1150) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_256 != null)
         {
            this.var_256(this.var_1149,this.var_1150);
         }
      }
