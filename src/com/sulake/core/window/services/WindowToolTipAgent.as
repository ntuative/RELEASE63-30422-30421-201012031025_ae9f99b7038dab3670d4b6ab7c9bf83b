   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IToolTipAgentService
   {
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            if(param1 is IInteractiveWindow)
            {
               ...
               this.var_1405 = IInteractiveWindow(param1).toolTipDelay;
            }
            else
            {
            ...
            if(this.var_1165 != null && this.var_1165 != "")
            {
               ...
               {
                  this.var_350 = new Timer(this.var_1405,1);
      ...
      override public function operate(param1:int, param2:int) : void
      {
         if(_window && true)
         {
            ...
            {
               this.var_255.x = param1 + this.var_1164.x;
               this.var_255.y = param2 + this.var_1164.y;
            }
         }
      }
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            if(this.var_255 == null || this.var_255.disposed)
            {
               this.var_255 = _window.context.create("undefined::ToolTip",this.var_1165,WindowType.const_353,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            this.var_255.x = _loc2_.x + this.var_1166.x + this.var_1164.x;
            this.var_255.y = _loc2_.y + this.var_1166.y + this.var_1164.y;
         }
      }
