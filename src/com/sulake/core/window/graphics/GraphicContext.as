package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_733:uint = 1;
      
      public static const const_882:uint = 2;
      
      public static const const_665:uint = 4;
      
      public static const const_1401:uint = 8;
      
      public static const const_1407:uint = 16;
      
      public static const const_1778:uint = 64;
      
      public static const const_1583:uint = 128;
      
      public static const const_943:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_882:
               ...
               break;
            case GraphicContext.const_1401:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1407:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_665:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_943:
               break;
            case GraphicContext.const_1310:
               break;
            default:
         ...
         if(this.var_758)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1872,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1872,16777215);
                  }
                  var_289 += bitmap.width * bitmap.height * 4;
               }
