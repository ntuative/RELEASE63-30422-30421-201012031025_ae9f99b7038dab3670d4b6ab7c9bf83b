package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1376:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1807 = new Point();
         this.var_1376 = new Rectangle();
         this.var_282 = new Rectangle();
         this.var_341 = new Dictionary(true);
         this.var_847 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_741 = null;
            for(_loc1_ in this.var_341)
            {
               delete this.var_341[_loc1_];
            }
            this.var_341 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_282,WindowRedrawFlag.const_1102);
            if(this.var_741.indexOf(param1) == -1)
            {
               this.var_741.push(param1);
            }
         }
      }
      ...
      {
         var _loc2_:WindowRendererItem = this.var_341[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_341[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_847);
            this.var_341[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_608,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_608,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_341[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_341[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_741.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_741.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1807,this.var_1376))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1807,this.var_1376))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1376);
