package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_878:uint = 8;
      
      private static const const_1230:String = "skin";
      
      private static const const_1232:String = "bitmap";
      
      private static const const_1231:String = "fill";
      
      private static const const_1236:String = "text";
      
      private static const const_1235:String = "shape";
      
      private static const const_1234:String = "unknown";
      
      private static const const_1233:String = "null";
      ...
      private var var_2534:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_900 = new Dictionary();
         this.var_899 = new Dictionary();
         this.var_1811 = new Dictionary();
         this.var_2533 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1811,this.var_2533);
         this.var_2534 = new Dictionary();
         this.var_2532 = new Dictionary();
         StateCodeTable.fillTables(this.var_2534,this.var_2532);
         this.var_493 = new Dictionary();
         this.var_493[const_1230] = BitmapSkinRenderer;
         this.var_493[const_1232] = BitmapDataRenderer;
         this.var_493[const_1231] = FillSkinRenderer;
         this.var_493[const_1236] = TextSkinRenderer;
         this.var_493[const_1235] = ShapeSkinRenderer;
         this.var_493[const_1234] = SkinRenderer;
         this.var_493[const_1233] = NullSkinRenderer;
         if(var_290 == null)
         {
            var_290 = new Array();
            var_290.push(WindowState.const_61);
            var_290.push(WindowState.const_69);
            var_290.push(WindowState.const_81);
            var_290.push(WindowState.const_47);
            var_290.push(WindowState.WINDOW_STATE_HOVERING);
            var_290.push(WindowState.const_76);
            var_290.push(WindowState.const_100);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1811[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_900[param1] == null)
         {
            this.var_900[param1] = new Array(const_878);
         }
         this.var_900[param1][param2] = param3;
         if(this.var_899[param1] == null)
         {
            this.var_899[param1] = new Array(const_878);
         }
         this.var_899[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_900[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_272)
            {
               _loc4_ = _loc3_["null"];
            }
         }
