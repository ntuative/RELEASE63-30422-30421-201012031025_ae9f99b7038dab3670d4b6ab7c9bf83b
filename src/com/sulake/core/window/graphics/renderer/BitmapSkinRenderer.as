package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_760:Dictionary;
      
      private var var_892:Matrix;
      
      public function BitmapSkinRenderer(param1:String)
      {
         super(param1);
         this.var_761 = new Dictionary(false);
         this.var_760 = new Dictionary(false);
         this.var_892 = new Matrix();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_761 = null;
            for(_loc1_ in this.var_760)
            {
               _loc2_ = this.var_760[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_760[_loc1_];
            }
            this.var_760 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_409[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_474)
                  {
                     _loc14_ = true;
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_474)
                  {
                     _loc15_ = true;
                  ...
                  {
                     this.var_892.a = _loc13_.width / _loc19_.width;
                     this.var_892.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,this.var_892);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,this.var_892,null);
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_760[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
