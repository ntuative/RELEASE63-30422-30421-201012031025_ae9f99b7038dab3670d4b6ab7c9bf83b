package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1602:String = "_INCLUDE";
      
      public static const const_1682:String = "_TEMP";
      ...
      protected var var_1404:Dictionary;
      
      protected var var_1874:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1404 = new Dictionary();
         ParamCodeTable.fillTables(this.var_929,this.var_1404);
         this.var_1874 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1202,"");
         return param1.replace(const_1201,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1404)
            {
               delete this.var_1404[_loc1_];
            }
            this.var_1874.dispose();
            this.var_1874 = null;
            this.var_16 = null;
            this._disposed = true;
         }
