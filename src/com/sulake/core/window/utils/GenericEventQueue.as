package com.sulake.core.window.utils
{
   ...
   public class GenericEventQueue implements IEventQueue, IDisposable
   {
      ...
      {
         var _loc1_:* = null;
         if(this._index < this.var_410.length)
         {
            _loc1_ = this.var_410[this._index];
            ++this._index;
         }
         return _loc1_;
      }
      ...
      {
         this.var_410.splice(this._index - 1,1);
         if(this._index > 0)
         {
            --this._index;
         }
      ...
      {
         this.var_410.splice(0,this.var_410.length);
         this._index = 0;
      }
      
      protected function eventListener(param1:Event) : void
      {
         this.var_410.push(param1);
      }
   }
}
