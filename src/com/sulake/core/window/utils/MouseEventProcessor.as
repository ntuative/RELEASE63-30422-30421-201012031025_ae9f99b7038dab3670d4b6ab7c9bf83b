package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_141:IWindowRenderer;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_131 = param1.desktop;
         this.var_79 = param1.var_1148 as WindowController;
         this._lastClickTarget = param1.var_1146 as WindowController;
         this.var_141 = param1.renderer;
         this.var_756 = param1.var_1145;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_621.x || _loc3_.stageY != this.var_621.y)
            {
               ...
               _loc6_ = new Array();
               this.var_131.groupParameterFilteredChildrenUnderPoint(this.var_621,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_79 != this.var_131 && !this.var_79.disposed)
                  {
                     ...
                     this.var_79 = WindowController(this.var_131);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_79 && !this.var_79.disposed)
                     {
                        ...
                        {
                           this.var_756.mouseEventReceived(_loc3_.type,this.var_79);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_131;
         param1.var_1148 = this.var_79;
         param1.var_1146 = this._lastClickTarget;
         param1.renderer = this.var_141;
         param1.var_1145 = this.var_756;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_141.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_453))
         {
