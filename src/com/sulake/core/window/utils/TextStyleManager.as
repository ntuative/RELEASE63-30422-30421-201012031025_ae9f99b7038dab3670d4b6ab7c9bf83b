package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_313:String = "regular";
      ...
      private static const const_1140:String = "/*";
      
      private static const const_1139:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_81[const_313],var_81[ITALIC],var_81[BOLD]];
            var_81.reset();
            var_81[const_313] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_544);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_544))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_544 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1140) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1139) + 2,_loc5_.length);
            }
