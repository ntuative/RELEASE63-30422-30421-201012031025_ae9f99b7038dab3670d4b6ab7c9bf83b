package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_911[param1];
         if(_loc4_ == null)
         {
      ...
      {
         var _loc2_:LocalizationDefinition = this.var_911[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_911[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2545);
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1822);
         }
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this._localizations)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1822);
            }
         }
      }
   }
