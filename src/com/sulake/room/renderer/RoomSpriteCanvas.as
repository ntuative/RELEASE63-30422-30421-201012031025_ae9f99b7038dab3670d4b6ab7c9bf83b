package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1228:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2117:Number = -1.0E7;
      
      private var var_2118:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_224.addChild(this.var_53);
      ...
      {
         this.var_452.x -= param1 - this.var_548;
         this.var_548 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_452.y -= param1 - this.var_552;
         this.var_552 = param1;
      }
      ...
      {
         if(param1 && !this.var_810)
         {
            this.var_810 = true;
            if(this.var_118 != null && !this.var_224.contains(this.var_118))
            {
               this.var_224.addChild(this.var_118);
               this.var_53.mask = this.var_118;
            }
         }
         else if(!param1 && this.var_810)
         {
            this.var_810 = false;
            if(this.var_118 != null && this.var_224.contains(this.var_118))
            {
               this.var_224.removeChild(this.var_118);
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_653 != this.var_2119 || this._ht != this.var_2116)
         {
            _loc9_ = true;
         }
         if(this.var_53.x != this.var_548 || this.var_53.y != this.var_552)
         {
            this.var_53.x = this.var_548;
            this.var_53.y = this.var_552;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_453.sortOn("z",0 | 0);
         if(_loc5_ < this.var_453.length)
         {
            this.var_453.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_453[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2119 = this.var_653;
         this.var_2116 = this._ht;
      }
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc19_ < this.var_653 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
      ...
      {
         if(param1 < 0 || param1 >= this.var_453.length)
         {
            return null;
         }
         return this.var_453[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_548;
         param2 -= this.var_552;
         this.var_452.x = param1;
         this.var_452.y = param2;
         if(this.var_993 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1535;
         }
         this.var_1535 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_993;
         return this.var_1535;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_653 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1534,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_549.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_549.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2117 || param2 != this.var_2118)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_549.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_549.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_300.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1228.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_993 == 0)
         {
            this.checkMouseHits(this.var_452.x,this.var_452.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_993 = 0;
         ++this.var_1534;
      }
