package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_1685:Number = 1.0;
      
      private var var_1684:Number = 1.0;
      ...
      private var var_2627:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1083 = new Vector3d();
         this.var_1685 = 1;
         this.var_1684 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1686 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_236.x,this.var_236.y,this.var_236.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_391 != param1 * this.var_1685)
         {
            this.var_391 = param1 * this.var_1685;
            ++this.var_143;
         }
      }
      ...
      {
         if(this.var_393 != param1 * this.var_1684)
         {
            this.var_393 = param1 * this.var_1684;
            ++this.var_143;
         }
      }
      ...
      {
         if(this.var_392 != param1 * this.var_1686)
         {
            this.var_392 = param1 * this.var_1686;
            ++this.var_143;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_236.x;
         var _loc3_:Number = this.var_236.y;
         var _loc4_:Number = this.var_236.z;
         this.var_236.assign(param1);
         if(this.var_236.x != _loc2_ || this.var_236.y != _loc3_ || this.var_236.z != _loc4_)
         {
            ++this.var_143;
         }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1083.assign(_loc22_);
         }
         else
         {
            this.var_1083.assign(_loc17_);
         }
         ++this.var_143;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1083);
         if(_loc3_ < this.var_2626 || _loc3_ > this.var_2627)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_393;
            _loc2_.z *= this.var_392;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1083);
         }
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1012;
         }
         else
         {
            this.scale = const_575;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_575;
      }
