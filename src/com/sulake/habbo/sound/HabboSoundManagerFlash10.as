package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_613:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_952,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_913.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1344:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1462:
               ...
               case HabboSoundTypesEnum.const_1059:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1454:
            ...
            this.var_913.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_614.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_745.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_745,events);
         _loc8_.volume = this.var_497;
         this.var_912 = null;
         this.var_744 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_914.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_914 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_161 == null || this._connection == null || this._roomEngine == null || this.var_613 != null)
         {
            return;
         }
         this.var_613 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_614.getValue(_loc2_);
         ...
         this.var_614.remove(_loc2_);
         this.var_745.add(_loc3_,_loc6_);
         if(this.var_614.length == 0 && this.var_744 != -1)
         {
            this.var_912.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_952,this.var_744));
            this.var_744 = -1;
            this.var_912 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_613.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1348,this.var_744));
         this.var_744 = -1;
         this.var_912 = null;
      }
      ...
      {
         this.var_497 = param1;
         this.var_613.updateVolume(this.var_497);
