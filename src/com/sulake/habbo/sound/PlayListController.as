package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1817:String = "type_sound_machine";
      
      private const const_1557:String = "type_jukebox";
      
      private var var_608:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_647,this.onSongFinishedPlayingEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_791,this.onSoundMachinePlayEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_757,this.onSoundMachineStopEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_809,this.onJukeboxInitEvent);
         this.var_88.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_501,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_647,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_791,this.onSoundMachinePlayEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_757,this.onSoundMachineStopEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_809,this.onJukeboxInitEvent);
               this.var_88.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_501,this.onDisposeEvent);
               this.var_88 = null;
            }
            if(this.var_396)
            {
      ...
      {
         this.startPlaying(this.const_1817);
      }
      ...
      {
         this.startPlaying(this.const_1557);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_276 = _loc2_.id;
            this.playSong(this.var_276);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_276 == param1)
         {
            this.playSong(this.var_276);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_396[this.var_276] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_396.getValue(this.var_276) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_276 = param1;
         var _loc2_:IHabboSound = this.var_396.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_608.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_608.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_276)
         {
            _loc6_ = this.var_396[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1735 == this.const_1557)
         {
            this.var_76.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_598.indexOf(param1) == -1)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_598 = this.var_598.splice(this.var_598.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_396[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_608.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_396.add(_loc3_.id,_loc7_);
            }
