package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_719:ITextFieldWindow;
      ...
      {
         this.var_719 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_719.procedure = this.onSearchInput;
         this.var_719.addEventListener(WindowKeyboardEvent.const_144,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_55.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_326,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_381.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_719.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_719.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_719.text;
