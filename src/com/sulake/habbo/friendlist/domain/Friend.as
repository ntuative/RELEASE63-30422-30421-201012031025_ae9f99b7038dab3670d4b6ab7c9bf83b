package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_701 = param1.online;
         this.var_1433 = param1.followingAllowed && param1.online;
         this.var_560 = param1.figure;
         this.var_1784 = param1.motto;
         this.var_1696 = param1.lastAccess;
         this.var_1282 = param1.categoryId;
         this.var_1695 = param1.realName;
