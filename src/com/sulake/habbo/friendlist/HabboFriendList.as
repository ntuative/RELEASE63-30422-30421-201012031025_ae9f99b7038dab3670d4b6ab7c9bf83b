package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_930:IAvatarRenderManager;
      
      private var var_623:ISessionDataManager;
      
      private var var_1890:FriendListLookAndFeel;
      ...
      private var var_291:FriendRequests;
      
      private var var_1412:AvatarSearchResults;
      ...
      {
         this.var_1890 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1412 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_514.stop();
            this.var_514.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_514 = null;
         }
         ...
         if(this.var_930)
         {
            this.var_930.release(new IIDAvatarRenderManager());
            this.var_930 = null;
         }
         if(this.var_914)
         {
            this.var_914.release(new IIDHabboNotifications());
            this.var_914 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_623)
         {
            this.var_623.release(new IIDSessionDataManager());
            this.var_623 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1411 = new OpenedToWebPopup(this);
         }
         this.var_1411.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_291.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_277,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_930.createAvatarImage(param1,AvatarScaleType.const_84,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_930 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_914 = param2 as IHabboNotifications;
      ...
      {
         this.var_623 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_291 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1001,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_315,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_514)
         {
            this.var_514 = new Timer(120000);
            this.var_514.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_514.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_315);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_327));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_291.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_291.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_359.findTab(FriendListTab.const_90).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_291.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_359.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1412.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_359.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_623 || !this.var_291)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_623.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_291.vipLimit;
         }
         else if(this.var_623.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_291.clubLimit;
         }
         if(_loc2_ > this.var_291.limit)
         {
            this.var_291.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_148) as IBitmapWrapperWindow;
