package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_728:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2112:IContainerButtonWindow;
      
      private var var_2111:IContainerButtonWindow;
      
      private var var_2113:IContainerButtonWindow;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_381 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2112 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2111 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2113 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2110 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_728);
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_728);
      ...
      private function method_5(param1:Boolean) : uint
      {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2112,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2111,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2113,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2110,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_381.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_381.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_290)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_290 && _loc4_.online)
            {
