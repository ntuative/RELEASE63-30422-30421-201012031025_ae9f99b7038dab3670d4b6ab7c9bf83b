package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1551:String = "no_reqs_info";
      ...
      private var var_1669:IContainerButtonWindow;
      
      private var var_1668:IContainerButtonWindow;
      ...
      {
         this.var_1669 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1668 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1668.procedure = this.onDismissAllButtonClick;
         this.var_1669.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_358)
         {
         ...
         else if(param1.state == FriendRequest.const_931)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_358;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_358 && _loc4_.state != FriendRequest.const_357)
            {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_358 && _loc4_.state != FriendRequest.const_357)
            {
               ...
               _loc4_.state = FriendRequest.const_358;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1669,_loc1_);
         this.setEnabled(this.var_1668,_loc1_);
      }
