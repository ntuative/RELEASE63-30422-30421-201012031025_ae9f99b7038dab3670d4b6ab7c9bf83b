   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_801,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_535,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_801,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1087,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1091,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_535,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1175)
            {
               ...
               this.var_1175 = _loc3_;
               this.var_1434 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1434;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1063,HabboToolbarIconEnum.MEMENU);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_718);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_590);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_813);
         _loc1_.push(RoomWidgetStopEffectMessage.const_759);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1346);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_909);
         _loc1_.push(RoomWidgetToolbarMessage.const_646);
         _loc1_.push(RoomWidgetToolbarMessage.const_670);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_365);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1341);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1086);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_627);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_744);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_633);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1482);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_747);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_603);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_623);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_342);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_744:
            ...
            case RoomWidgetWaveMessage.const_629:
               ...
               break;
            case RoomWidgetDanceMessage.const_718:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_590:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_784:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_813:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1002)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_579:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_897:
                        this._catalog.openCatalogPage(CatalogPageName.const_1308,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_889:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_282);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1412:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1259:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_909:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_627:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_646:
               ...
               break;
            case RoomWidgetToolbarMessage.const_670:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_483,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_365:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_633:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_747:
            ...
            case RoomWidgetStoreSettingsMessage.const_603:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_380,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_623:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_491));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_342:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_535:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_488));
         }
      }
