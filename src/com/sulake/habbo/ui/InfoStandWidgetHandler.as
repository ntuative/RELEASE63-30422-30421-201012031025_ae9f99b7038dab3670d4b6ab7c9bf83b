package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_150,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_150,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_654.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_654.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_771);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_792);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_714);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_734);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_701);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1460);
         _loc1_.push(RoomWidgetPetCommandMessage.const_777);
         _loc1_.push(RoomWidgetPetCommandMessage.const_658);
         _loc1_.push(RoomWidgetUserActionMessage.const_475);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_489)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_379 || param1.type == RoomWidgetUserActionMessage.const_475 || param1.type == RoomWidgetUserActionMessage.const_425)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_560:
               ...
               break;
            case RoomWidgetUserActionMessage.const_475:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_738:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1101,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_771:
            ...
            case RoomWidgetUserActionMessage.const_657:
               ...
               break;
            case RoomWidgetUserActionMessage.const_792:
            ...
            case RoomWidgetFurniActionMessage.const_297:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_714:
            ...
            case RoomWidgetUserActionMessage.const_379:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_734:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_701:
            ...
            case RoomWidgetPetCommandMessage.const_658:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_777:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_312);
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_927);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_349)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1078)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_458);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_219)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_250)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_656);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1455;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1105;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_924;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1484);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_654.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_48);
            this.var_654.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_656);
