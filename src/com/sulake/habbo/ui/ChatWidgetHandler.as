   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_351 != null)
         {
            ...
            {
               _loc2_ = this.var_351.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_773,RoomWidgetChatSelectAvatarMessage.const_810];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_773:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_810:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_351.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_352.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_763.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_220)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_351.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_352.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_763.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_932 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_932);
            }
