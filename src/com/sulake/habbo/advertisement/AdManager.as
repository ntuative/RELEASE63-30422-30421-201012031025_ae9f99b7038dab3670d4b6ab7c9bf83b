package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_966:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2028 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2030 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2031 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1502 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_967 == 0)
         {
            this.var_967 = getTimer();
            return false;
         }
         if(this.var_1502 > 0 && this.var_1501 >= this.var_1502)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_967;
         if(_loc1_ > this.var_2030)
         {
            ++this.var_1501;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1207 = _loc2_.imageUrl;
         this.var_2029 = _loc2_.clickUrl;
         this.var_967 = getTimer();
         if(this.var_1207 != "")
         {
            _loc3_ = this.var_1207;
            ...
            {
               this.var_192 = new Timer(this.var_2031,1);
            ...
            this.var_192.start();
            _loc4_ = new URLRequest(this.var_1207);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_472,0,0,param1.bitmapData,this.var_2029));
            this.var_967 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_534));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1208 = _loc2_.imageUrl;
         this.var_1500 = _loc2_.clickUrl;
         if(this.var_1208 != "" && this.var_1500 != "")
         {
            _loc3_ = this.var_1208;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1208);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_529,0,0,_loc4_,this.var_1500,this.var_968,this.var_966));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_966 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
