package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1808 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1130 = this.var_1808.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1130)
         {
            this.var_1130.procedure = this.onButtonClick;
         }
         this.var_1129 = this.var_1808.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1129)
         {
            this.var_1129.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_247 >= this._localizations.length - 1)
         {
            this.var_1129.disable();
         }
         else
         {
            this.var_1129.enable();
         }
         if(this.var_247 <= 0)
         {
      ...
      {
         ++this.var_247;
         this.var_247 = Math.min(this.var_247,this._localizations.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_247][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_247][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_247][1]).value;
