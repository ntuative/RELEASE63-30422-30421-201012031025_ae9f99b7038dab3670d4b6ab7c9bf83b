package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_357.push(new ActorIsOnFurni());
         this.var_357.push(new FurnisHaveAvatars());
         this.var_357.push(new StatesMatch());
         this.var_357.push(new TimeElapsedMore());
         this.var_357.push(new TimeElapsedLess());
      }
