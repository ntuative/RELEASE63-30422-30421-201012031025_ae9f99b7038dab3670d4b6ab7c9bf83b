package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class TimeElapsedLess implements ConditionType
   {
      ...
      private var var_1022:SliderWindowController;
      ...
      {
         return ConditionCodes.var_1841;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         var _loc3_:int = this.var_1022.getValue();
      ...
      {
         this.var_88 = param2;
         this.var_1022 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1200,1);
         this.var_1022.setValue(1);
         this.var_1022.addEventListener(Event.CHANGE,this.onSliderChange);
      }
      
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         var _loc3_:int = param2.intParams[0] - 1;
         this.var_1022.setValue(_loc3_);
      }
