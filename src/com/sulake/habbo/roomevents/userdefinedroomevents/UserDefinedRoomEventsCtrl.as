package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1101 = new SliderWindowController(this.var_88,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_88.assets,0,20,1);
         this.var_1101.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1101.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_713.hideAll(this.var_240);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_713.showAll(this.var_240);
         if(this.var_57 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_57);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1101.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_57 as TriggerDefinition != null)
         {
            this.var_88.send(new UpdateTriggerMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_57 as ActionDefinition != null)
         {
            this.var_88.send(new UpdateActionMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_57 as ConditionDefinition != null)
         {
            this.var_88.send(new UpdateConditionMessageComposer(this.var_57.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1101.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.send(new ApplySnapshotMessageComposer(this.var_57.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1738);
