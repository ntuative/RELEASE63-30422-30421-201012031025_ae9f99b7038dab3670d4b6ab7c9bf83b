package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class ScoreAchieved implements TriggerConf
   {
      ...
      {
         return TriggerConfCodes.var_1852;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1022.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_88 = param2;
         this.var_1022 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,1000,1);
