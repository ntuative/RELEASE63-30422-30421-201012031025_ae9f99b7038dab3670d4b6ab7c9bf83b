package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class TriggerConfs implements ElementTypeHolder
   {
      ...
      public function TriggerConfs()
      {
         ...
         super();
         this.var_232.push(new AvatarSaysSomething());
         this.var_232.push(new AvatarEntersStuff());
         this.var_232.push(new AvatarExitsStuff());
         this.var_232.push(new TriggerOnce());
         this.var_232.push(new StuffIsUsed());
         this.var_232.push(new TriggerPeriodically());
         this.var_232.push(new AvatarEntersRoom());
         this.var_232.push(new GameStarts());
         this.var_232.push(new GameEnds());
         this.var_232.push(new ScoreAchieved());
      }
