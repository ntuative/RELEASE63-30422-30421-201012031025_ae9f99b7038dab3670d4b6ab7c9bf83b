package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_340:PetDataManager;
      
      private var var_740:PaletteManager;
      
      private var var_527:String;
      
      private var var_281:Map;
      
      private var var_211:AvatarAssetDownloadManager;
      
      private var var_1803:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_527 = RenderMode.const_1373;
         this.var_281 = new Map();
         this.var_97 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_103,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_97.add(AvatarType.const_103,_loc4_);
         ...
         this.var_97.add(AvatarType.const_65,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_340 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_740 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_340.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_211)
         {
            this.var_211.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_340.init();
         this.var_740.init();
         _loc2_ = this.var_97.getValue(AvatarType.const_103) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_97.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_97.getValue(AvatarType.const_103) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_211 == null)
               {
                  ...
                  this.var_211 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_211.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_896)
         {
            if(this.var_2529 && this.var_2527 && this.var_2528)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_211.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_211.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_97.getValue(AvatarType.const_103) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_211.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1803)
         {
            this.var_1803 = new AvatarFigureContainer(this.const_1829);
         }
         this.var_211.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1803,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_281 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_281.getKeys())
         {
            _loc4_ = this.var_281.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1295)
         {
            _loc6_ = !this.var_340.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_340.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_97.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_281.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_340.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_97.getValue(AvatarType.const_65);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_281.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_281.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_97.getValue(AvatarType.const_103) as AvatarStructure;
      ...
      {
         return this.var_340 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_65:
               _loc3_ = this.var_97.getValue(AvatarType.const_65) as AvatarStructure;
               break;
            default:
