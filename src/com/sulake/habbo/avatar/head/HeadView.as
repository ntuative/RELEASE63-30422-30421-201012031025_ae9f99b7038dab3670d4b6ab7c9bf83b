   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_184,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_217,_windowManager,_assetLibrary);
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_237,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_62 && var_132 == "")
         {
            var_62.switchCategory(FigureData.const_184);
         }
      }
