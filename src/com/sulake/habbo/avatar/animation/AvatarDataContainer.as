package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1703:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_1666 = new ColorTransform(this.var_1703,this.var_1701,this.var_1702,this._alphaMultiplier);
         this.var_1077 = this.generatePaletteMapForGrayscale(this.var_2320,this.var_2321);
      }
      ...
      {
         return this.var_1077.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1077.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1077.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1077.getValue("alphas") as Array;
      }
