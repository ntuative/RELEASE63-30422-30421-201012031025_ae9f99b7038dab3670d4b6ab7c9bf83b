package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_640:String = "bodypart";
      
      public static const const_519:String = "fx";
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         this.var_2240 = parseInt(param2.@frame);
         this._dx = parseInt(param2.@dx);
         this.var_1355 = parseInt(param2.@dy);
         this.var_1356 = parseInt(param2.@dz);
         this.var_1643 = parseInt(param2.@dd);
         this._type = param3;
         this.var_1027 = String(param2.@base);
      ...
      private function baseAsInt() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1027.length)
         {
            _loc1_ += this.var_1027.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
