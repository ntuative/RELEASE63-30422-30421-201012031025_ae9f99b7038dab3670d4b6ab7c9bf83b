package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_806 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_998 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_806)
               {
                  this.var_806.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_998)
            {
