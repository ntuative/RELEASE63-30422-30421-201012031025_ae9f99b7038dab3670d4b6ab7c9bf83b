package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1398:IWindowContainer;
      
      public static var var_1855:int = 6710886;
      ...
      private var var_431:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_430:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_945 = [];
         this.var_1185 = [AvatarEditorFigureCategory.const_753,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_244,AvatarEditorFigureCategory.const_804,AvatarEditorFigureCategory.const_962,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1398 == null)
         {
            ...
            var_1398 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_360 = new Timer(1000);
         this.var_360.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1185;
         }
         for each(_loc6_ in param4)
         {
            this.var_945.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_360.stop();
            this.var_360.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_360 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1185);
         }
         if(param1.length != this.var_945.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_945.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_1977 = this.canChangeOutfit();
            this.var_360.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_431 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_431.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_431.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_945.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_431.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_431.numSelectables)
               {
                  this.var_431.getSelectableAt(_loc6_).x = this.var_431.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1185;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1462 == AvatarEditorSideCategory.const_99 || this.var_1979))
         {
         ...
         this.setViewToCategory(this.var_314);
      }
      ...
      {
         if(this.var_1462 == AvatarEditorSideCategory.const_99)
         {
            this.var_1979 = false;
            this.setSideContent(AvatarEditorSideCategory.const_726);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_726:
               break;
            case AvatarEditorSideCategory.const_482:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_482);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_430)
         {
            ...
            this.var_430 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_430.procedure = this.stripClubDialogEventProc;
            this.var_430.center();
         }
         else
         {
