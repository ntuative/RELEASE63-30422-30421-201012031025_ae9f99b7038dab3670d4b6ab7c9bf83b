package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2186 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         this.var_1114 = new Dictionary();
         this.var_1766 = new Array();
         for each(_loc4_ in param1.avatarset)
         {
            _loc3_ = new AvatarSet(_loc4_);
            this.var_1114[String(_loc4_.@id)] = _loc3_;
         }
         for each(_loc5_ in param1.bodypart)
         {
            this.var_1766.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1766.concat();
         for each(_loc3_ in this.var_1114)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2465 = _loc6_;
      }
