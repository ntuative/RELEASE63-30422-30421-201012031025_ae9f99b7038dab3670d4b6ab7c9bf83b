package com.sulake.habbo.avatar.geometry
{
   ...
   public class GeometryBodyPart extends Node3D
   {
      ...
      public function GeometryBodyPart(param1:XML)
      {
         ...
         this.var_1328 = parseFloat(param1.@radius);
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - this.var_1328);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + this.var_1328);
