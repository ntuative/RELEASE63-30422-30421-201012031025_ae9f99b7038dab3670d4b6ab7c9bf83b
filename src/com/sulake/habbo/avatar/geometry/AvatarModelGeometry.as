package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_840 = new Vector3D(0,0,10);
         super();
         this.var_1054 = new Matrix4x4();
         this.var_683 = new Dictionary();
         this.var_1640 = new Dictionary();
         this.var_1639 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_840.x = _loc11_;
            this.var_840.y = _loc12_;
            this.var_840.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_683[String(_loc6_.@id)] = _loc7_;
            this.var_1640[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_683)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1639.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1639.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_683[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_683[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_683[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1640[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1054 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1054);
            _loc9_ = _loc7_.getDistance(this.var_840);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1054 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1054,this.var_840,param4);
         }
         return [];
      }
