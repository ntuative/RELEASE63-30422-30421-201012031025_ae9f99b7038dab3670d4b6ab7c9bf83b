package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_560 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_560.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1379 = this.var_1378;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_43)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1379);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_253.definition.geometryType);
         if(this.var_39 == null || _loc4_ != null && (this.var_39.width != _loc4_.width || this.var_39.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_253.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_580);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_560,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1379 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_580);
                  _loc20_ = this.var_85;
                  _loc21_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_580);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_560,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_84)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_580);
                  _loc21_ = this.var_85;
                  _loc22_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_470 = this.var_470 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function sortActions() : void
      {
         ...
         this.var_1377 = this._structure.sortActions(this.var_287);
         ...
         {
            this.var_670 = this._structure.getCanvasOffsets(this.var_1377,this._scale,this.var_85);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1377)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_206)
               {
                  this.var_879 = true;
               }
