package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1196:String = "Default";
      
      private static const const_1197:int = 2;
      
      private static const const_1195:String = AvatarSetType.const_32;
      ...
      protected var var_1871:int;
      
      protected var var_253:IActiveActionData;
      
      protected var var_657:Boolean;
      
      protected var var_670:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_242:AvatarImageCache;
      
      protected var var_560:AvatarFigureContainer;
      ...
      private var var_2304:String = null;
      
      private var var_2305:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1195,const_1197);
         this.var_287 = new Array();
         this.var_898 = new ActiveActionData(AvatarAction.const_335);
         this.var_898.definition = this._structure.getActionDefinition(const_1196);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_657)
         {
            ...
            if(this.var_686)
            {
               for each(_loc2_ in this.var_686)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_560,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1643;
         if(param2 < AvatarDirectionAngle.const_1075)
         {
            param2 = AvatarDirectionAngle.const_288 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_288)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_580,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_270.length == 1 && this.var_85 == this.var_1871)
         {
            return this.var_85 + this.var_470 + this.var_580 % 4;
         }
         if(this.var_270.length == 2)
         {
            for each(_loc1_ in this.var_270)
            {
               ...
               {
                  return this.var_85 + this.var_470 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_580 % 11;
                  return this.var_85 + "_" + this.var_1871 + this.var_470 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2306 || param2 != this.var_2304 || param1 != this.var_2305)
         {
            this.var_2306 = param3;
            this.var_2304 = param2;
            this.var_2305 = param1;
            this.var_1644 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_253.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1160 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1160)
            {
               this.var_39.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_253.definition.geometryType,this.var_85);
         this.var_39.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_580);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_253.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_253.definition.geometryType,this.var_85);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_580);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_580));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_253 = this.var_898;
         this.var_253.definition = this.var_898.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_470 = "";
         this.var_270 = this._structure.sortActions(this.var_287);
         if(this.var_270 == null)
         {
            this.var_670 = new Array(0,0,0);
            if(this.var_1299 != "")
            {
               _loc1_ = true;
               this.var_1299 = "";
         ...
         {
            this.var_670 = this._structure.getCanvasOffsets(this.var_270,this._scale,this.var_85);
            for each(_loc4_ in this.var_270)
            {
               this.var_470 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_284)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1300 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1299 != this.var_470)
            {
               _loc1_ = true;
               this.var_1299 = this.var_470;
            }
         }
         this.var_1298 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_270)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_879 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1643 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_274 || _loc1_.actionType == AvatarAction.const_206 || _loc1_.actionType == AvatarAction.const_367)
               {
                  this.var_879 = true;
               }
            }
