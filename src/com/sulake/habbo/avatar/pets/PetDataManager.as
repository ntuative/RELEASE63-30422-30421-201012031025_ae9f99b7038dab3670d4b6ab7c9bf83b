package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      private var var_141:AvatarRenderManager;
      ...
      public function init() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(_loc2_ != null)
            {
               ...
               if(this.var_374.getValue(_loc4_) == null)
               {
                  this.var_374.add(_loc4_,new PetData(_loc3_));
               }
            }
         }
      }
      ...
      public function removeListener(param1:IPetDataListener = null) : void
      {
         ...
         var _loc2_:int = this.var_455.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_455.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_455.length > 0)
         {
            _loc1_ = this.var_455.pop() as IPetDataListener;
      ...
      {
         var _loc3_:IPetData = this.var_374.getValue(param1) as IPetData;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc4_:PetData = this.var_374.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = this.var_374.getKeys();
         for each(key in speciesKeys)
         {
            petData = this.var_374.getValue(key);
            if(petData != null)
            {
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1236.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_557.getValue(_loc6_) == null)
               {
                  ...
                  this.var_557.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_455.indexOf(param3) == -1)
                  {
                     this.var_455.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_557.getKeys())
         {
            _loc5_ = this.var_557.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_251.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
            this.var_251.splice(_loc3_,1);
