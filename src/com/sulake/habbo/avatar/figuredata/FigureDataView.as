package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_987 = _loc4_.content as BitmapData;
         }
      ...
      {
         if(this.var_384 && this.var_987)
         {
            this.var_384.bitmap = new BitmapData(this.var_384.width,this.var_384.height,true,16777215);
            this.var_384.bitmap.copyPixels(this.var_987,this.var_987.rect,new Point(0,this.var_384.height - this.var_987.height - 8));
