package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_866:int = 3;
      
      private var var_399:AssetLoaderStruct;
      ...
      private const const_1819:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_399 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_865 = new Timer(this.const_1819,1);
         this.var_865.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_399)
         {
            this.var_399.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_399.addEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_399)
         {
            this.var_399.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_399.removeEventListener(AssetLoaderEvent.const_42,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_866);
            if(this.var_1348.indexOf("?") > 0)
            {
               _loc2_ = this.var_1348 + "&retry=" + this.var_866;
            }
            else
            {
               _loc2_ = this.var_1348 + "?retry=" + this.var_866;
            ...
            this.var_399 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         for each(_loc2_ in param1.lib)
         {
            ...
            for each(_loc4_ in _loc2_.part)
            {
               ...
               _loc6_ = this.var_1103[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(_loc3_);
               this.var_1103[_loc5_] = _loc6_;
            }
         }
      }
      ...
      public function loadFigureSetData(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_455[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_455[_loc3_] = _loc6_;
            }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_864)
         {
            _loc7_ = true;
            _loc4_ = this.var_864[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_455[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_864[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_714.length > 0 && this.var_715.length < this.const_1516)
         {
