package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1132:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1131:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_948:AvatarEditorHandler;
      ...
      private var var_1190:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_813 = FigureData.const_72;
      ...
      private function init() : void
      {
         ...
         if(!this.var_173)
         {
            ...
            this.var_522["null"] = new FigureData(this);
            this.var_522["null"] = new FigureData(this);
            _loc1_ = this.var_522["null"];
            _loc2_ = this.var_522["null"];
            _loc1_.loadAvatarData(const_1132,FigureData.const_72);
            _loc2_.loadAvatarData(const_1131,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_433 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_753,new BodyModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_43,new HeadModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_244,new TorsoModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_804,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_962,new HotLooksModel(this));
            this.var_433.add(AvatarEditorSideCategory.const_99,new WardrobeModel(this));
            this.var_433.add(AvatarEditorSideCategory.const_482,new ClubPromoModel(this));
            this.var_173 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_947 = param3;
         var _loc4_:FigureData = this.var_522[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_773.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_773.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_218 == null)
            {
               this.var_218 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_218.addChild(this._view.window);
               if(param5)
               {
                  this.var_218.center();
               }
            ...
            this.var_218.visible = !this.var_218.visible;
         }
         this._view.show();
      ...
      {
         var _loc2_:ISideContentModel = this.var_433.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_434 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_773 = this.var_434.getFigureData(AvatarType.const_103);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_948 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_522[this.var_813];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1190 != null)
         {
            ...
            this.var_1190.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1468;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_947 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1133)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_434.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_434.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_947 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_947 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_433.getValue(AvatarEditorSideCategory.const_99);
      }
