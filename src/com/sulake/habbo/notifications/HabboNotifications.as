package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1181:String = "pixelbalance";
      
      private static const const_1178:String = "badges";
      
      private static const const_1180:String = "selectbadge";
      
      private static const const_1176:String = "inventory";
      
      private static const const_1175:String = "selectfurni";
      
      private static const const_1177:String = "credits";
      
      private static const const_1182:String = "friendlist";
      
      private static const const_1179:String = "pet_inventory";
      ...
      private var var_671:IHabboToolbar;
      ...
      private var var_825:ClubGiftNotification;
      
      private var var_826:ClubEndingNotification;
      
      private var var_827:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_824);
         }
         var _loc6_:Map = this.var_824["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_671)
         {
            this.var_671.release(new IIDHabboToolbar());
            this.var_671 = null;
         }
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_824["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1023.push(_loc8_);
         return this.var_1023.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1023.splice(0,1);
      ...
      {
         this.var_671 = IHabboToolbar(param2);
         this.var_671.events.addEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_73)
         {
            ...
            this.var_459 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_824["styles"],this.var_824["view"],this.var_671);
            ...
            this.var_379.events.addEventListener(BadgeImageReadyEvent.const_115,this.onBadgeImage);
            this.var_671.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1274[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_379);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1435);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_379.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_985);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_985);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1278);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_434.createAvatarImage(param2,AvatarScaleType.const_48);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_379.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_79)
               {
                  _loc9_ = this.var_379.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_379.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1449,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_79:
               ...
               break;
            case CatalogPageMessageProductData.const_207:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1053)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1338);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1477)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_826 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_827 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1592 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_459.isSpaceAvailable() && this.var_1023.length > 0)
         {
            this.var_459.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1178:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_282);
               }
               break;
            case const_1180:
               break;
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_434.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1014,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_434.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2211)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1093);
            this.var_2211 = true;
      ...
      {
         if(param2.type == WindowEvent.const_171 || param2.type == WindowEvent.const_795)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_825 && this.var_825.visible)
         {
            return;
         }
         this.var_825 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1093,_loc6_);
      }
   }
}
