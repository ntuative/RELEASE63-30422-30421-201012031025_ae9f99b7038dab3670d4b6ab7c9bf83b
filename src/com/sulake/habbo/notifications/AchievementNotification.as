package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1542:String = "badge_bg_001_png";
      
      private const const_1805:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this._badgeName = this.registerAchievementParameters("badge_name_" + this.var_267);
         this.var_2220 = this.registerAchievementParameters("badge_desc_" + this.var_267);
         this.var_2218 = this.registerAchievementParameters("badge_name_fb_" + this.var_267);
         this.var_2216 = this.registerAchievementParameters("badge_desc_fb_" + this.var_267);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2217 = this.registerTextParameters("notifications.text.achievement_facebook");
         this.var_2219 = this.registerTextParameters("notifications.text.achievement_facebook_title");
         ...
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1275.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1275.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1598;
         var _loc17_:String = this.var_1598 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_1897);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1542);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1805) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1275 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_267,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_267,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_267,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"level",this.var_1597.toString());
         this._localizations.registerParameter(param1,"name",this.var_379.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_379.realName);
      }
      ...
      private function registerTextParameters(param1:String) : String
      {
         ...
         this._localizations.registerParameter(param1,"badge_desc",this.var_2220);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2218);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2216);
         this._localizations.registerParameter(param1,"level",this.var_1597.toString());
         this._localizations.registerParameter(param1,"name",this.var_379.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_379.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_379.events.removeEventListener(BadgeImageReadyEvent.const_115,this.onBadgeImageReady);
            this.var_379 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_267)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1542);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_267,this.var_2219,this.var_2217,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2221));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_267,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_267,"client.skip_post"));
               this.dispose();
               return;
         }
      }
