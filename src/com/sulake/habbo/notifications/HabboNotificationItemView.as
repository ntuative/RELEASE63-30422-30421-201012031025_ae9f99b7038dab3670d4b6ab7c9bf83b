package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_612:int = 70;
      
      public static const const_515:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1482 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1482 = 15;
         }
         this.var_1483 = this._window.height;
         this.var_639 = 4;
         this.var_640 = 0;
         this._state = name_1;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_510:
               this.var_961 += param1;
               _loc2_ = Number(this.var_961) / Number(this.var_362["time_fade_in"]);
               if(this.var_961 > int(this.var_362["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_825:
               ...
               if(this.var_1199 > int(this.var_362["time_display"]) && !this.var_1484)
               {
                  this.startFadeOut();
               }
               break;
            case const_824:
               this.var_962 += param1;
               _loc3_ = 1 - Number(this.var_962) / Number(this.var_362["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_962 > int(this.var_362["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1482;
         if(this._window.height < this.var_1483)
         {
            this._window.height = this.var_1483;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_362["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_515;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_515;
            }
         }
         else if(this.var_362["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_515;
         }
         else
         ...
         if(this.var_362["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_639;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_639;
            }
         }
         else if(this.var_362["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_639;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_640;
      }
   }
}
