package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_634)
         {
            this.var_634 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_634)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_633)
         {
            this.var_633 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_633)
            {
               return;
            }
