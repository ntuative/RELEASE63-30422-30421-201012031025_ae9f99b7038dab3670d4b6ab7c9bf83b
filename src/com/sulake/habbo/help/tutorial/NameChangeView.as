package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1187:uint = 13232628;
      
      private static var var_1463:uint = 11129827;
      ...
      private var var_946:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1464 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_634)
         {
            this.var_634 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_634)
            {
               return;
            }
            this._window.content.addChild(this.var_634);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_633)
         {
            this.var_633 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_633)
            {
               return;
            }
            this._window.content.addChild(this.var_633);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_633.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_432;
         }
         this.showView(this.var_633);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_432);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_748:
            ...
            case ChangeUserNameResultMessageEvent.var_750:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_747:
               break;
            ...
            case ChangeUserNameResultMessageEvent.var_920:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_921:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_921 || param1 == ChangeUserNameResultMessageEvent.var_920)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_946 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_946.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1187;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_432 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_432);
               break;
