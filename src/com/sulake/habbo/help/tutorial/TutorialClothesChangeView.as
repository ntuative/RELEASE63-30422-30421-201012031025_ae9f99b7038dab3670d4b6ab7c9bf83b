package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_46.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_46,this.onShowMenuEvent);
      ...
      public function dispose() : void
      {
         ...
         this.var_46.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_46,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_46)
         {
            ...
            this.var_46.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_535));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_659 = this.var_46.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         ...
         this.var_46.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU_ARROW,this.var_659));
      }
