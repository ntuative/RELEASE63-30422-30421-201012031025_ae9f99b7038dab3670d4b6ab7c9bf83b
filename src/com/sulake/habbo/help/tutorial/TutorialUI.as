package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_352:String = "TUI_NAME_VIEW";
      
      public static const const_361:String = "TUI_CLOTHES_VIEW";
      
      public static const const_399:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_330:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         this.var_46 = param1;
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_422,this.onTaskDoneEvent);
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_438,this.onTaskDoneEvent);
         this.var_46.events.addEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
      }
      ...
      {
         return this.var_1349 && this.var_1108 && this.var_1350;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_46)
         {
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_422,this.onTaskDoneEvent);
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_438,this.onTaskDoneEvent);
            this.var_46.events.removeEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
            this.var_46 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_422:
               this.var_1350 = true;
               if(this.var_37 != null && this.var_37.id == const_399)
               {
                  this.showView(const_86);
               }
               break;
            case HabboHelpTutorialEvent.const_438:
               if(this.var_37 != null && this.var_37.id == const_361)
               {
                  this.var_1746 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1601 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_352:
               ...
               if(this.var_330 == null)
               {
                  this.var_330 = new NameChangeView(this);
               }
               this.var_330.showMainView();
               this.prepareForTutorial();
               break;
            case const_361:
         ...
         this._window.height = _loc2_.height + this.var_1602;
         this._window.width = _loc2_.width + this.var_1601;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_46.hideUI();
         this.var_46.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_102));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_37 != null && (this.var_37.id == const_352 || this.var_37.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      {
         this.var_1349 = true;
         if(this.var_37 != null && (this.var_37.id == const_361 || this.var_37.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_330.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_501)
         {
            this.var_330.checkedName = _loc2_.name;
         }
         else
         {
            this.var_330.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
