package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1303:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_584 = this.getKey("url_prefix");
         if(this.var_584 != null && this.var_584.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_584 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1300);
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_584 = this.getKey("url.prefix");
         if(this.var_584.length > 0)
         {
            externalAccessDomain = this.var_584.replace("http://","");
      ...
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_584);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(this.var_1652.indexOf(param1) < 0)
         {
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1303);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1303,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
