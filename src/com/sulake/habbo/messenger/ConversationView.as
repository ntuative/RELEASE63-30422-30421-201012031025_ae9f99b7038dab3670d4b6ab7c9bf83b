package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_865:int = 100;
      
      private static const const_1208:int = 20;
       
      
      private var var_121:HabboMessenger;
      
      private var var_2389:IScrollbarWindow;
      
      private var var_1710:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_121 = param1;
         this.var_1710 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_55 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2389 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_865 + const_1208)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1209;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_483 == null || _loc1_.id != this.var_483.id)
         {
            this.var_483 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_483.followingAllowed)
         {
            this.var_1710.enable();
         }
         else
         {
            this.var_1710.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_55.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_483.messages.length - const_865);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_483.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_483.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_788 || param3.type == Message.const_761 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_483.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_121.send(new FollowFriendMessageComposer(this.var_483.id));
      }
