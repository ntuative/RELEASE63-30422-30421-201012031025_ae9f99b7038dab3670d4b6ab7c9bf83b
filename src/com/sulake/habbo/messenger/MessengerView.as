package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_772:ConversationsTabView;
      
      private var var_771:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1184:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_17 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_121.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MESSENGER,this.var_17));
         }
         else
         {
            this.refresh();
      ...
      public function refresh() : void
      {
         ...
         this.var_772.refresh();
         this.var_1184.refresh();
         if(this.var_121.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1184.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_772 = new ConversationsTabView(this.var_121,this.var_17);
         this.var_772.refresh();
         this.var_771 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_771.addEventListener(WindowKeyboardEvent.const_144,this.method_9);
         this.var_1184 = new ConversationView(this.var_121,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_689,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_915,true);
      }
      ...
      private function method_9(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_771.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_771.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_771.text;
         ...
         this.var_771.text = "";
         this.var_121.conversations.addMessageAndUpdateView(new Message(Message.const_788,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_772 == null ? 7 : int(this.var_772.getTabCount());
      }
   }
}
