package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_807:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_46.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_322));
         Logger.log("BEGINNING TO SHOW: " + this.var_322);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1494;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_807 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1237 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1238 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function refreshRoomData(param1:RoomData, param2:String) : void
      {
         ...
         if(!param1.exists)
         {
            this.var_55.removeListItem(_loc3_);
            this.var_55.removeListItem(this.var_55.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_46,WindowTracker.const_607,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_807.isSelected);
         this.var_46.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1450,_loc2_,this.var_450.text,"",""));
         if(this.var_1237.isSelected || this.var_1238.isSelected || this.var_807.isSelected)
         {
            this.var_46.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1237.isSelected,this.var_1238.isSelected,this.var_807.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1282);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_46.initMsg.roomMessageTemplates[this.var_980.selection];
         if(_loc3_ != null)
         {
            this.var_605 = false;
