package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1017:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_119.getHighestPriorityIssue();
         this.var_458 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_1017 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_458.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_119.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_119.reportedUserId > 0)
         {
            this.var_1017.load(_loc4_,this.var_119.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_119.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = this.var_119.issues;
         var _loc5_:int = 0;
      ...
      {
         if(this.var_60 != null && this.var_60.issueManager != null && this.var_119 != null)
         {
            this.var_60.issueManager.removeHandler(this.var_119.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_119.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_119.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_119.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.releaseBundle(this.var_119.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_119.getHighestPriorityIssue().issueId;
         this.var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_60,WindowTracker.const_916,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_119.getHighestPriorityIssue();
            this.var_458 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
