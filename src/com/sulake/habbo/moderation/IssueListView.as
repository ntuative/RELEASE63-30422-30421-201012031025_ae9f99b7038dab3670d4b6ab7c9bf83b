package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1443:IWindowContainer;
      
      private var var_2650:BitmapData;
      
      private var var_2649:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_1443 = this.var_541.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1443 == null)
            {
               return;
            }
            _loc2_ = this.var_1443.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = this.var_55.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_541.assets.getAssetByName(_loc8_) as BitmapDataAsset;
