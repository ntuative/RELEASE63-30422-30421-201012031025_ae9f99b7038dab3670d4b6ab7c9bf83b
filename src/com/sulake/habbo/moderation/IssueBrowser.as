package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1815:String = "my_issues";
      
      private const const_1813:String = "open_issues";
      
      private const const_1814:String = "picked_issues";
      
      private const const_1834:String = "closed_issues";
      ...
      private var var_1687:IIssueBrowserView;
      
      private var var_1689:IIssueBrowserView;
      
      private var var_1688:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_237 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_237.numTabItems)
            {
               _loc5_ = this.var_237.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_58,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_237 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_237 == null || this.var_237.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_237.selector.getSelectableByName("open_issues");
         this.var_237.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_325.view.width = this.var_237.container.width;
         this.var_325.view.height = this.var_237.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1815:
               ...
               {
                  this.var_1687 = new MyIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1687;
            case this.const_1813:
               if(this.var_1689 == null)
               {
                  this.var_1689 = new OpenIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1689;
            case this.const_1814:
               if(this.var_1688 == null)
               {
                  this.var_1688 = new PickedIssuesView(this.issueManager,this,this.var_237.container);
               }
