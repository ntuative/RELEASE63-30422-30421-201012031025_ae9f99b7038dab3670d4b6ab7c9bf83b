package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1043:String = "issue_bundle_open";
      
      public static const const_569:String = "issue_bundle_my";
      
      public static const const_1013:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_541 = new IssueBrowser(this,this.var_60.windowManager,this.var_60.assets);
         this.var_978 = [];
         this.var_979 = [];
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_978 = this.var_978.concat(_loc4_.getIssueIds());
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_541 == null || !this.var_541.isOpen())
         {
            this.var_60.soundManager.playSound(HabboSoundTypesEnum.const_1028);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_788.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_788.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1324)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_92)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_788.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2076++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_788.add(param1.issueId,_loc2_);
         ...
         if(this.var_978.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_569);
            _loc7_ = false;
            ...
            _loc9_ = this.var_979.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_647.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_647.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_788.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_92.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_647.remove(param1);
         this.var_647.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_647.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_375 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_647.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
