package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1637:IMessageComposer;
      ...
      {
         this.var_933 = IWindowContainer(this.var_46.getXmlWindow("chatlog_roomheader"));
         this.var_934 = IWindowContainer(this.var_46.getXmlWindow("chatlog_chatline"));
         ...
         this.var_46.connection.send(this.var_1637);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_933.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_934.clone());
         _loc4_.color = this.var_1419[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
      ...
      private function refreshListDims() : void
      {
         ...
         {
            _loc2_ = IWindowContainer(this.var_55.getListItemAt(_loc1_));
