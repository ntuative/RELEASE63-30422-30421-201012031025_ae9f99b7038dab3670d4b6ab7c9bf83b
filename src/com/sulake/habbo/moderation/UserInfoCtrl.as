package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_870:int = 60;
      
      private static const const_872:int = 3600;
      
      private static const const_873:int = 86400;
      
      private static const const_871:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_870) + " mins ago";
         }
         if(param1 < 2 * const_873)
         {
            return Math.round(param1 / const_872) + " hours ago";
         }
         if(param1 < 2 * const_871)
         {
            return Math.round(param1 / const_873) + " days ago";
         }
         return Math.round(param1 / const_871) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_46,WindowTracker.const_966,this._data.userId),this._callerFrame,this.var_1123,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new RoomVisitsCtrl(this.var_46,this._data.userId),this._callerFrame,this.var_1123,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new SendMsgsCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1226),this._callerFrame,this.var_1123,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ModActionCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1226),this._callerFrame,this.var_1123,false,true);
      }
