package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1398:uint = 9;
      
      public static const const_178:uint = 0;
      
      public static const const_185:uint = 1;
      
      public static const const_372:uint = 2;
      
      public static const const_307:uint = 3;
      
      public static const const_509:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_48.updateItemList(this.var_681);
         this.var_48.updateItemList(this.var_1295);
      ...
      public function close() : void
      {
         if(this.var_709)
         {
            if(this._state != const_178 && this._state != const_248)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_178;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1058);
            this.var_709 = false;
         }
      ...
      {
         this.var_48.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_682 + " OTHER: " + this.var_1050);
         ...
         {
            case const_178:
               if(param1 == const_185 || param1 == const_248)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_268.length)
         {
            _loc2_ = this.var_268.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_1019);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_681)
            {
               this.var_682 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1050 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_681)
            {
               this.var_48.alertPopup(TradingView.const_991);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_268.length < const_1398)
         {
         ...
         else
         {
            ...
            if(this.var_268.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
