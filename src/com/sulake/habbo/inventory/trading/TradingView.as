package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_847:uint = 4284532064;
      
      private static const const_846:uint = 2577770;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_381 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1603 = this.createMinimizedWindow();
         }
         if(!this.var_2237)
         {
            return this.var_65;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_847) : uint(const_846);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_847) : uint(const_846);
            }
         ...
         if(this.var_65)
         {
            ...
            switch(this.var_22.state)
            {
               ...
               case TradingModel.const_307:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_509:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_248:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_893)
            {
            ...
            this.var_381.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_415);
            this.var_381.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_381.hideDelayed();
         }
      }
