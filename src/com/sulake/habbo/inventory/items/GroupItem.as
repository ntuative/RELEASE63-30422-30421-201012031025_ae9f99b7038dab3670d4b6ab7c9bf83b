package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_622:BitmapData;
      
      protected var var_2316:int;
      
      protected var var_1407:Boolean;
      
      protected var var_1877:Boolean;
      
      protected var var_2600:BitmapData;
      
      private const const_1798:int = 8947848;
      
      private const const_1797:int = 13421772;
      
      private const const_1559:Number = 1;
      
      private const const_1558:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_1873 = param8;
         this.var_1542 = param9;
         if(param10 != null)
         {
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1542));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1873);
         }
         if(_loc1_.id > 0)
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_610)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1558;
               _loc1_.blend = this.const_1558;
            }
            else
            {
               this._window.blend = this.const_1559;
               _loc1_.blend = this.const_1559;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1877 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2600;
               _loc5_.visible = true;
            }
            else
            {
