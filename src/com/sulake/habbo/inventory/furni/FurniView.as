package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1832:int = 0;
      
      private const const_828:int = 1;
      
      private const const_1534:int = 2;
      
      private const const_1532:int = 3;
      
      private const const_1533:int = 42;
      
      private const const_1535:int = 120;
      ...
      private var var_665:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_440.add(FurniModel.const_40,new FurniGridView(this.var_62,FurniModel.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_440.add(FurniModel.const_45,new FurniGridView(this.var_62,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_440.getValue(this.var_365);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_365);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_828;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1534;
         }
         else
         {
            _loc2_ = this.const_1532;
         }
         if(this.var_2053 == _loc2_)
         {
            return;
         }
         this.var_2053 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_828:
               ...
               break;
            case this.const_1534:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1532:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_365);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_665 && this.var_665.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1535)
         {
            _loc3_ = this.const_1535;
         }
         else if(_loc3_ < this.const_1533)
         {
            _loc3_ = this.const_1533;
         }
         else
         {
