package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_954:IRoomSession;
      ...
      private const const_1795:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_20 != null)
         {
            this.var_20.events.removeEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
            this.var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_442,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_44.getValue(InventoryCategory.const_78));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_44.getValue(InventorySubCategory.const_299));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_44.getValue(InventoryCategory.const_652));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_44.getValue(InventoryCategory.const_282));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_44.getValue(InventoryCategory.const_322));
      }
      ...
      {
         return PetsModel(this.var_44.getValue(InventoryCategory.const_147));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_44.getValue(InventoryCategory.const_338) as MarketplaceModel;
      }
      ...
      {
         this.var_20 = IRoomSessionManager(param2);
         this.var_20.events.addEventListener(RoomSessionEvent.const_85,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionEvent.const_92,this.roomSessionEventHandler);
         this.var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_442,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               this.var_954 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_442:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_379 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_20 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_44.add(InventoryCategory.const_338,_loc1_);
         ...
         this.var_44.add(InventoryCategory.const_652,_loc4_);
         ...
         this.var_44.add(InventoryCategory.const_322,_loc5_);
         ...
         this.var_44.add(InventorySubCategory.const_299,_loc6_);
         ...
         this.var_44.add(InventoryCategory.const_147,_loc8_);
         this.var_173 = true;
         if(this.var_1985)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_299:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_775.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_775.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_775.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_775.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1795);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1087));
      }
