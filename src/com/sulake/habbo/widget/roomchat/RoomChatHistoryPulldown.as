package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private var var_1996:BitmapData;
      
      private var var_2000:BitmapData;
      
      private var var_1998:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_35 = param3;
         this.var_1997 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1486 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_1995 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1487 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1485 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_1996 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2000 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_67 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_277,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,param3.width,param3.height - const_77),null,0,0) as IBitmapWrapperWindow;
         ...
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_682,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_77),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_510:
               this.var_67.blend += param1 / const_826;
               this._window.blend += param1 / const_826;
               ...
               break;
            case const_824:
               this.var_67.blend -= param1 / const_827;
               this._window.blend -= param1 / const_827;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_35.width - this.var_1998;
         }
         if(this.var_67 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_1999 == this._window.width)
         {
            return;
         }
         this.var_1999 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_1995;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1487;
            _loc2_.disposesBitmap = false;
            this.var_1998 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1997,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1486,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1486,_loc9_);
         ...
         this.var_67.bitmap = this.var_2000;
