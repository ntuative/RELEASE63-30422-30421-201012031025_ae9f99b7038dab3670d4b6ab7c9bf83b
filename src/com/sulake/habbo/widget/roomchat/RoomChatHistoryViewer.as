package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1119:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1048:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_657 = false;
         this._widget = param1;
         this.var_151 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_151.state = RoomChatHistoryPulldown.const_216;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_151.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_216);
      }
      ...
      {
         return !!this.var_353 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_151.state == RoomChatHistoryPulldown.const_318 || this.var_151.state == RoomChatHistoryPulldown.const_510;
      }
      ...
      {
         if(!this.var_353 && !this.var_1592)
         {
            this.var_353 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_151.state = RoomChatHistoryPulldown.const_318;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_43 != null)
         {
            ...
            if(param2)
            {
               this.var_43.scrollV = this.var_516;
            }
         }
         if(this.var_151 != null)
         {
            this.var_151.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_354 > 0 && param2)
         {
            if(this.var_1416)
            {
               if(Math.abs(param1 - this.var_354) <= const_1048)
               {
                  return;
               }
               this.var_1416 = false;
            ...
            if(this.var_353)
            {
               ...
               _loc5_ = (param1 - this.var_354) / this.var_43.height;
               _loc3_ = this.var_516 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_354;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_43.scrollV < 1 - const_1119 / this.var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1417)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_43 != null)
         {
            this.var_516 = this.var_43.scrollV;
         }
         if(this.var_43 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_516 - this.var_43.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
