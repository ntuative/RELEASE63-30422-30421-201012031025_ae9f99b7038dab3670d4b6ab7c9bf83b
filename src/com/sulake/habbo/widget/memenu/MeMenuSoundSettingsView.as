package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_497 = param1.volume;
         if(this.var_770 != null)
         {
            this.var_770.setValue(this.var_497);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_633));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_497 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1454);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1452);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_497 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1453);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1455);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_747);
         }
         else
         {
