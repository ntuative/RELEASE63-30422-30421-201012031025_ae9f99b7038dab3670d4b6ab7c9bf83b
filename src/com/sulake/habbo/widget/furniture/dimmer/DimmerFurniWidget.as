package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1144:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1143:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_572,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_593,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_572,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_593,this.onHide);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_972 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_1962 = param1.presetId;
         this.var_971 = param1.effectId;
         this._color = param1.color;
         this.var_973 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_973,this.var_971))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_973,this.var_971 == 2);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_972] as DimmerFurniWidgetPresetItem;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_973,this.var_971 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
