package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1138:Number = 100;
      
      private static const const_1137:Number = 100;
      ...
      private var var_556:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1138,const_1137,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_556 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_373 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_237 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_237.numTabItems)
         {
            _loc6_ = this.var_237.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1233 = _loc2_.light;
         if(this.var_373 != null)
         {
            this.var_373.setValue(this.var_1233);
         }
         this.var_489 = this.colors.indexOf(_loc2_.color);
         if(this.var_556 != null)
         {
            this.var_556.setSelectedColorIndex(this.var_489);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_237.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_237.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_237.selector.getSelected();
         return this.var_237.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1232 = XML(_loc1_.content);
         return this.var_1232;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_373 != null)
         {
            this.var_373.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_556 != null)
         {
            this.var_556.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
