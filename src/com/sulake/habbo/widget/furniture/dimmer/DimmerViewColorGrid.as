package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1823) as IWindowContainer;
            ...
            _loc3_.width = this.var_615.width;
            _loc3_.height = this.var_615.height;
            this.var_498.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_615.width,this.var_615.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_615,this.var_615.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_915.width,this.var_915.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_915,this.var_915.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1823 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_615 = BitmapData(_loc3_.content);
         ...
         this.var_915 = BitmapData(_loc3_.content);
      }
