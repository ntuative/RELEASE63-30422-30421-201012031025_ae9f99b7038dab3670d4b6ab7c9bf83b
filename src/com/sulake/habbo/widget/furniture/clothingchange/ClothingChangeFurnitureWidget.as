package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_840:String = "Boy";
      
      private static const const_841:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_317,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_888,this.onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_377,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_317,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_888,this.onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_377,this.onUpdate);
      }
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_317:
               this.showGenderSelectionInterface(param1);
               break;
            case RoomWidgetClothingChangeUpdateEvent.const_377:
               this.hideEditorInterface();
         }
      }
      ...
      {
         this.hideGenderSelectionInterface();
         this.var_294 = param1.objectId;
         this.var_2156 = param1.objectCategory;
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_662 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      {
         this.requestEditor(FigureData.const_72);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         this.var_662 = _loc4_;
         this.var_662.offset(100,100);
         var _loc6_:IWindow = this.var_662.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_342,param1,this.var_294,this.var_2156,this._roomId,this._roomCategory,_loc5_);
