package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_208:IBorderWindow;
      ...
      private const const_1820:int = 158;
      
      private const const_1825:int = 16;
      
      private const const_1823:uint = 11184810;
      
      private const const_1828:uint = 6710886;
      
      private const const_1821:uint = 3355443;
      
      private const const_1824:String = "level";
      
      private const const_1827:String = "experience";
      
      private const const_1822:String = "energy";
      
      private const const_1826:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_208 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_208.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_208.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_208.width < this.var_63.width)
         {
            this.var_208.x = this._window.width - this.var_208.width;
            this.var_63.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1824,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1827,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1822,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1826,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1369.remove(param1.id);
         this.var_1369.add(param1.id,param1);
         if(this.var_186 && this.var_186.isVisible() && param1.isOwnPet)
         {
            this.var_186.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_186.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1820,this.const_1825,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1823);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1821);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1828);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_186 == null)
         {
            this.var_186 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1369.getValue(this.var_559) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_186.showWindow(true);
            this.var_186.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_208 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_208 != null)
         {
            this.var_50 = this.var_208.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_208.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_208.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_186 && this.var_186.getPetId() == this.var_559)
               {
                  this.var_186.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_526,this._widget.petData.ownerId);
