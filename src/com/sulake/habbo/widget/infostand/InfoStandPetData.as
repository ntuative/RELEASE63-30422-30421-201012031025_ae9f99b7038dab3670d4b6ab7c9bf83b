package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1498 = param1.id;
         this._type = param1.petType;
         this.var_1966 = param1.petRace;
         this.var_39 = param1.image;
         this.var_1880 = param1.isOwnPet;
         this.var_1882 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1597 = param1.level;
         this.var_1886 = param1.levelMax;
         this.var_1888 = param1.experience;
         this.var_1881 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_1885 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_1883 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_1889 = param1.roomIndex;
         this.var_1884 = param1.age;
      }
   }
}
