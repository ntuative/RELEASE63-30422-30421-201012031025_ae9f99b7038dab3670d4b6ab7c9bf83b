package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_997;
         if(this.var_997 < this.var_805.length)
         {
            _loc1_ = this.var_805[this.var_997] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_372)
         {
            ...
            this.var_372 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_372.center();
            this.var_372.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_805[this.var_997] as Dictionary;
