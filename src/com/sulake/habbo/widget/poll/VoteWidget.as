package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1176:Array = null;
      
      private var var_1059:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1334 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_130,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_121,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_374,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_130,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_121,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_374,this.update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1334;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1334 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2333;
         if(_loc2_ > this.var_1334)
         {
            this.vote();
            return;
         }
