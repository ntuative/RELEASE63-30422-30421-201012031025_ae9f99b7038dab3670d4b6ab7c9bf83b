package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1194:Number = 25;
      
      private static const const_1221:Number = 90;
      
      private static const const_850:int = 50;
      ...
      private var var_1297:ToolbarView;
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_319[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_850 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_850 || param1.desktop.height - param1.y < const_1193;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1297.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_319.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1297.getIconLoc(param1.iconId);
      ...
      {
         return this.var_578[this.var_577.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_577[this.var_578.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_577.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_577.splice(_loc3_,1);
            this.var_578.splice(_loc3_,1);
         }
         this.var_578.push(param1.name);
         this.var_577.push(param2);
         param1.addEventListener(WindowEvent.const_324,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_579[_loc3_] == null)
            {
               this.var_579[_loc3_] = new Array();
            }
            if(this.var_579[_loc3_].indexOf(param1) < 0)
            {
               this.var_579[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_319.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_319.splice(this.var_319.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_578[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_577[_loc2_];
               if(this.var_579[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_579[_loc3_].length)
                  {
                     this.repositionWindow(this.var_579[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_319.length)
         {
            _loc2_ = this._itemList[this.var_319[_loc7_]];
            if(_loc2_.active)
            {
