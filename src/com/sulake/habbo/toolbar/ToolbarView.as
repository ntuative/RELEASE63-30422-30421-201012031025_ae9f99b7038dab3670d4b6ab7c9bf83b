package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_986:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_194 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_965,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_986 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_986)
         {
         ...
         this.var_985 = _loc6_.toolbar.@margin_top;
         this.var_1221 = _loc6_.toolbar.@margin_bottom;
         this.var_1519 = _loc6_.toolbar.@min_group_margin;
         this.var_1518 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_264 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_222,param1,param2,this._window,this.var_264);
         this.createGroupsFromXmlList(_loc8_,this.var_546,param1,param2,this.var_194,this.var_264);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_.method_3 = _loc7_.@icon_size;
            _loc9_.iconSize = _loc9_.method_3;
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_139,this.var_446,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_446);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_139,this.var_446);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_139,this.var_446);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_546.length)
         {
            _loc2_ = this.var_546[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_194.x = this.var_139 + this.var_1518;
               this.var_194.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_194.x = 0;
               this.var_194.y = this.var_139 + this.var_1518;
         ...
         while(_loc2_ < this.var_222.length)
         {
            ...
            _loc5_ += _loc3_.iconCount * _loc3_.method_3;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_985;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_222.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1519,(this._window.height - _loc5_ * _loc8_ - this.var_985 - this.var_1221) / (this.var_222.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1519,(this._window.width - _loc5_ * _loc8_ - this.var_985 - this.var_1221) / (this.var_222.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_222.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_446;
               _loc3_.iconSize = _loc3_.method_3 * _loc8_;
