package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1372 = param1.loop;
         if(param1.background != null)
         {
            this.var_888 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1372 == true || this.var_887 == 0)
         {
            if(this.var_889.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_889.length)
               {
                  this._frame = 0;
                  ++this.var_887;
               }
      ...
      {
         return this.var_889.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1372 == false && this.var_887 == 1 && this.var_1757 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_888.width),Math.max(param2.height,this.var_888.height));
            _loc3_.copyPixels(this.var_888,this.var_888.rect,new Point(0,0));
