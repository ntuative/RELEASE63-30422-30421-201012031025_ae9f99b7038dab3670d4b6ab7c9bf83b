package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_598:String = "RCL_LOADER_READY";
      
      private static const const_308:String = "RCL_PUBLICROOM_";
      
      private static const const_1531:int = 0;
      ...
      private static const const_1142:String = const_385;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_830:String = "tile_cursor";
      
      private static const const_829:String = "selection_arrow";
      ...
      private var var_1205:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_533 = [];
         this._wallItems = [];
         this.var_2024 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2027 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_828)
         {
            return;
         }
         this.var_1205 = param1;
         this.var_2026 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2021 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2023 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2025 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_438.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_438.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_364.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_364.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_644.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_534.add(_loc3_,_loc4_);
               if(this.var_533.indexOf(_loc7_) < 0)
               {
                  this.var_533.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_531.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_531.remove(_loc7_);
               this.var_531.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2022)
         {
            ...
            {
               this.var_1205.dispatchEvent(new Event(const_598));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_436 != null)
         {
            this.var_436.remove(param2);
            this.var_436.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_437 != null)
         {
            _loc2_ = this.var_437.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_436 != null)
         {
            _loc2_ = this.var_436.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_533.indexOf(param1) >= 0)
         {
         ...
         {
            return RoomObjectCategoryEnum.const_283;
         }
         return RoomObjectCategoryEnum.const_141;
      }
      ...
      {
         return [const_385,const_545,ROOM_CONTENT,const_830,const_829];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_534.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_532.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_532.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_644.getValue(param1) != null)
         {
      ...
      {
         if(this.var_176 != null && this.var_176.hasWorldType(const_308 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_167 || param1 == RoomObjectVisualizationEnum.const_65 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_531.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2025;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2023 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_533.indexOf(_loc4_) == -1)
                     {
                        this.var_533.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_176 = this.var_1206.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_699,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2024.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2027.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1206.add(_loc5_,_loc8_);
               this.var_176 = _loc8_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_643.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_643.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_438.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_643.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_438.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_438.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_209 && _loc5_ != RoomObjectLogicEnum.const_167)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_364.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_364.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_364[_loc2_] != null)
         {
            _loc3_ = this.var_364.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_308 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_308 + param1) == RoomObjectCategoryEnum.const_75)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_176.getWorldHeightScale(const_308 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_176 != null)
         {
            return this.var_176.getWorldScale(const_308 + param1);
         }
         return 32;
      }
