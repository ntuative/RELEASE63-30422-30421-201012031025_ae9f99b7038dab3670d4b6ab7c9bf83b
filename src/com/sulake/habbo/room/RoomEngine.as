package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_548:String = "temporary_room";
      
      private static const const_310:int = -1;
      
      private static const const_549:String = "room";
      
      private static const const_844:int = -2;
      
      private static const const_1174:String = "tile_cursor";
      
      private static const const_843:int = -3;
      
      private static const const_1173:String = "selection_arrow";
      
      private static const const_845:String = "overlay";
      ...
      private var var_667:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_667 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_283)
         {
            this.var_283.release(new IIDHabboAdManager());
            this.var_283 = null;
         }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_311.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = this.var_42.getRoom(this.getRoomIdentifier(this.var_93,this.var_94));
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_311.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_93 || _loc6_ != this.var_94 || !this.var_1014)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_769) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_781) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_790) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_724) + 0.5;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.visualizationFactory = this.var_487;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_42 != null)
         {
            ...
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_283);
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_598,this.onContentLoaderReady);
            this.var_15.initialize(events,this.var_117);
         }
         this.initializeRoomManager();
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_598)
         {
            this.var_2174 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_283 = param2 as IAdManager;
         this.var_283.events.addEventListener(AdEvent.const_529,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_379;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_24 != null)
         {
            ...
            {
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_246,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_478,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_496,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_161,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_669,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_123,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_98,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_444,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_DICE_OFF,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_486,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_434,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_446,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_432,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_524,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_398,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_487,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_465,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_298,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_518,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_362,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_347,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_439,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_930,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_479,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_24 == null || this.var_487 == null || this.var_42 == null || this.var_815 == null || this._communication == null || this.var_117 == null || !this.var_2174)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_457 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_785,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_310.length)
            {
               _loc3_ = this.var_310.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1055,_loc5_);
            if(_loc5_ == 0)
            {
            ...
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_395,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1055);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_457)
         {
            _loc5_ = this.var_310.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_310.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_723,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_694,1,true);
            _loc13_ = parseInt(this.var_117.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_950,_loc13_,true);
            if(this.var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_310,const_549,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_694,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_584,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_769,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_790,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_781,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1088,_loc14_,true);
               }
            }
         }
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_704,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_780,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_429,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_233);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_642,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_591,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_642,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1049,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_970,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_844,const_1174,RoomObjectCategoryEnum.const_283);
         _loc7_.createRoomObject(const_843,const_1173,RoomObjectCategoryEnum.const_283);
         return _loc7_;
      }
      
      public function getObjectRoom(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_310,RoomObjectCategoryEnum.const_75);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_310.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_310.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_704,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_780,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_984,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1076,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_722,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_934;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_584);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_591);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_642);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1049);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_970);
      ...
      {
         var _loc8_:int = param2 - this.var_1259;
         var _loc9_:int = param3 - this.var_1260;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1014 = true;
               this.var_814 = false;
               this.var_2175 = this.var_1259;
               this.var_2173 = this.var_1260;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1014)
            {
               if(!this.var_814)
               {
                  _loc8_ = param2 - this.var_2175;
                  _loc9_ = param3 - this.var_2173;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_537,this.var_93,this.var_94,-1,RoomObjectCategoryEnum.const_141));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_69 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_310,const_549);
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_845) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1258);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1259 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1260 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1258);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_93,this.var_94,this.var_1258);
         if(_loc1_ != null)
         {
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_694) != 0)
         {
            return false;
         }
         if(this.var_69 != null)
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_141;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_843,RoomObjectCategoryEnum.const_283);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_844,RoomObjectCategoryEnum.const_283);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_213,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_312,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_321,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_894,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_895,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_927,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_306,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE));
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_213,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_312,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_321,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_934,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_306,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1047) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1037);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_429,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_624,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_306,param1,param2,param3,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_808,this.var_93,this.var_94,param2,param3));
            }
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_27:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_213));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_445);
                     break;
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_457 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_42.getRoom(const_548);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_42.createRoom(const_548,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_667.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_213,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_445,param8);
               break;
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
            ...
            case RoomObjectCategoryEnum.const_75:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_767,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_745,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_690,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_429,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            this.var_1015.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_885,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            this.var_667.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_93,this.var_94,const_310,RoomObjectCategoryEnum.const_75,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_42.getRoom(const_548);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_885);
               ...
               this.var_667.freeNumber(_loc10_ - 1);
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_325,param1.image,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_978,param1.adWarningL,true);
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1004,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1103,RoomObjectVariableEnum.const_325,param1.clickUrl);
