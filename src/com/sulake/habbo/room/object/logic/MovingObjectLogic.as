package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_600:int = 500;
       
      
      private var var_1292:Vector3d;
      
      private var var_2661:Vector3d;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2287 = this._lastUpdateTime;
               this.var_1292 = _loc4_;
            }
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2287;
            if(_loc2_ > this.var_989)
            {
               _loc2_ = this.var_989;
            }
            _loc3_ = Vector3d.product(this.var_1292,_loc2_ / Number(this.var_989));
