package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_619,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_523,Number(false));
         this.var_690 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1103:
                  _loc2_.setString(RoomObjectVariableEnum.const_325,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_619,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_523,Number(true));
                  this.var_1358 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_950);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_523,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_394)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_619);
