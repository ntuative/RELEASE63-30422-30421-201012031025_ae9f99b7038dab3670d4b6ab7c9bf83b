package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1291:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_783,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_620,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_719,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_637,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1035)
         {
            ...
            if(_loc2_ - this.var_1035 >= this.var_1629)
            {
               _loc3_ = this.var_1036;
               _loc4_ = this.var_1630;
               this.var_1035 = 0;
            }
            else
            {
               _loc7_ = this.var_1291 >> 16 & 255;
               _loc8_ = this.var_1291 >> 8 & 255;
               _loc9_ = this.var_1291 & 255;
               _loc10_ = this.var_1036 >> 16 & 255;
               _loc11_ = this.var_1036 >> 8 & 255;
               _loc12_ = this.var_1036 & 255;
               _loc13_ = (_loc2_ - this.var_1035) / this.var_1629;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1627 + (this.var_1630 - this.var_1627) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_783,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_639:
               param2.setString(RoomObjectVariableEnum.const_767,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_704:
               param2.setString(RoomObjectVariableEnum.const_745,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_780:
               param2.setString(RoomObjectVariableEnum.const_690,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_429:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_233)
               {
                  _loc5_ = "null";
               }
               this.var_472.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_624:
               _loc4_ = this.var_472.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_472.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_908,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1076:
               param2.setNumber(RoomObjectVariableEnum.const_620,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_984:
               param2.setNumber(RoomObjectVariableEnum.const_719,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_637,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_956,int(param1.bgOnly));
         this.var_1291 = this._color;
         this.var_1627 = this.var_1628;
         this.var_1036 = _loc3_;
         this.var_1630 = _loc4_;
         this.var_1035 = getTimer();
         this.var_1629 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_435,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1481,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1265,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1490,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_435,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_153 || _loc13_ == RoomPlaneData.const_292)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
