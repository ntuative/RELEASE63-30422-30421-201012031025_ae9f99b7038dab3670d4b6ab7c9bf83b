package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_651:int = 0;
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.height == param1 && Vector3d.isEqual(this.var_717,param2))
               {
                  return this.var_30;
               }
               this.var_30.dispose();
