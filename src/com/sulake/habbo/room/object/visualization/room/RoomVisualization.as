package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1277:int = 16777215;
      
      public static const const_1393:int = 13421772;
      
      private static const const_853:int = 16777215;
      
      private static const const_852:int = 13421772;
      
      private static const const_851:int = 10066329;
      
      private static const const_854:int = 10066329;
      
      public static const const_1474:int = 16777215;
      
      public static const const_1270:int = 13421772;
      
      public static const const_1375:int = 10066329;
      ...
      private var var_688:Rectangle = null;
      
      private var var_472:RoomPlaneBitmapMaskParser = null;
      
      private var var_1528:String = null;
      ...
      private var var_1060:uint = 16777215;
      
      private var var_2309:int = 255;
      ...
      private const const_1811:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_472 = new RoomPlaneBitmapMaskParser();
         this.var_271["null"] = false;
         this.var_271["null"] = true;
         this.var_271["null"] = true;
         this.var_271["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_116.length)
            {
               _loc4_ = this.var_116[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_688 = super.boundingRectangle;
         }
         return new Rectangle(this.var_688.x,this.var_688.y,this.var_688.width,this.var_688.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_116.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_116[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1088);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_169)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1277;
               }
               else
               {
                  _loc13_.color = const_1393;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_153)
            {
               ...
               {
                  _loc13_.color = const_854;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_853;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_852;
               }
               else
               {
                  _loc13_.color = const_851;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1504)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_114,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1811 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(_loc7_)
         {
            ...
            {
               _loc10_ = this.var_583[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_321[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_94)
               {
                  if(this.var_1650)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2311 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2310 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2309 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1511)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1217 || _loc3_.y != this.var_2060 || _loc3_.z != this.var_2064 || param1.scale != this.var_2063))
            {
               this.var_1217 = _loc3_.x;
               this.var_2060 = _loc3_.y;
               this.var_2064 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_783));
            if(_loc4_ != this.var_1060)
            {
               this.var_1060 = _loc4_;
               this.var_2311 = this.var_1060 & 255;
               this.var_2310 = this.var_1060 >> 8 & 255;
               this.var_2309 = this.var_1060 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_956));
            if(_loc5_ != this.var_1650)
            {
               this.var_1650 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_767);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_690);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_620));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_719));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_637));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_116[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_271["null"] || param2 != this.var_271["null"] || param3 != this.var_271["null"])
         {
            this.var_271["null"] = param1;
            this.var_271["null"] = param2;
            this.var_271["null"] = param3;
            this.var_321 = [];
            this.var_583 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_321;
         if(this.var_321.length == 0)
         {
            _loc6_ = this.var_116;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_321.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_189)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_271[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_321.push(_loc12_);
                        this.var_583.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1540;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_472.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_116.length)
         {
            _loc3_ = this.var_116[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_472.maskCount)
         {
            _loc10_ = this.var_472.getMaskType(_loc8_);
            _loc11_ = this.var_472.getMaskLocation(_loc8_);
            _loc12_ = this.var_472.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_116.length)
               {
                  _loc3_ = this.var_116[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_94 && _loc12_ == RoomPlaneBitmapMaskData.const_233)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_116[_loc18_] as RoomPlane;
