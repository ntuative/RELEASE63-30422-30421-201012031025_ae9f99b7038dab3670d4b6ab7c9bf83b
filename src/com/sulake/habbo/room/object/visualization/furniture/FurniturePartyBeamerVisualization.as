package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_823:int = 15;
      
      private static const const_822:int = 31;
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(_loc2_ != null)
         {
            this.var_637[0] = this.getNewPoint(0,param1);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_637[1] = this.getNewPoint(1,param1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(param1 == 2 || param1 == 3)
         {
            ...
            {
               return this.var_637[param1 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param1 == 2 || param1 == 3)
         {
            if(this.var_637.length == 2)
            {
               return this.var_637[param1 - 2].y;
            }
         }
         return super.getSpriteYOffset(param1,param2,param3);
      }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_957[param1];
         var _loc4_:int = this.var_955[param1];
         var _loc5_:int = this.var_958[param1];
         var _loc6_:Number = this.var_956[param1];
         if(param2 == 32)
         {
            _loc7_ = const_823;
         }
         ...
         this.var_957[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_956[param1] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_957.push(Math.random() * _loc2_ * 1.5);
         this.var_957.push(Math.random() * _loc2_ * 1.5);
         this.var_955 = new Array();
         this.var_955.push(1);
         this.var_955.push(-1);
         this.var_958 = new Array();
         this.var_958.push(const_1136);
         this.var_958.push(ANIM_SPEED_SLOW);
         this.var_956 = new Array();
         this.var_956.push(this.getRandomAmplitudeFactor());
         this.var_956.push(this.getRandomAmplitudeFactor());
      }
