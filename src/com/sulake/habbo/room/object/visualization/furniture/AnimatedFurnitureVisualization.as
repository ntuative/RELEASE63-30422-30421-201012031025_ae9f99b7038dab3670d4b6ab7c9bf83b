package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_486:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_486 = param1 as AnimatedFurnitureVisualizationData;
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1745)
                     {
                        this.var_1745 = _loc4_;
      ...
      private function resetAnimationFrames() : void
      {
         ...
         this.var_1107 = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1744)
         {
            this.var_485[_loc1_] = null;
            this.var_599[_loc1_] = false;
      ...
      {
         if(this.var_486 != null && this._state >= 0)
         {
            if(this.var_486.hasAnimation(AnimationData.getTransitionAnimationId(param1),this.var_1743))
            {
               if(this.var_1106 != AnimationData.getTransitionAnimationId(param1))
               {
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         {
            this.var_1744 = this.var_486.getLayerCount(param1);
            this.resetAnimationFrames();
         }
         var _loc2_:Array = this.updateAnimationFrames(param1);
         if(this.var_1107 && _loc2_ != null && AnimationData.isTransitionAnimation(this.var_1106))
         {
            this.setAnimation(AnimationData.getAnimationId(this.var_1106));
      ...
      private function updateAnimationFrames(param1:Number) : Array
      {
         ...
         if(this.var_580 == 0)
         {
            this.var_580 = this.var_486.getStartFrame(this.animationId,param1);
         }
         this.var_580 += 1;
         var _loc3_:* = null;
         this.var_1107 = true;
         var _loc4_:int = this.var_1744 - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this._animationPlayed[_loc4_];
            if(!_loc5_)
            {
               _loc6_ = this.var_599[_loc4_];
               _loc7_ = this.var_485[_loc4_] as AnimationFrame;
               if(_loc7_ != null)
               {
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats >= 0 && _loc9_ <= 0)
               {
                  ...
                  if(_loc8_ == AnimationFrame.const_958)
                  {
                     _loc7_ = this.var_486.getFrame(_loc4_,this.animationId,this.var_580,param1);
                  }
                  else
                  {
                     _loc7_ = this.var_486.getFrameFromSequence(_loc4_,this.animationId,_loc8_,_loc7_.activeSequenceOffset + _loc7_.repeats,this.var_580,param1);
                  }
                  this.var_485[_loc4_] = _loc7_;
                  if(_loc3_ != null)
                  {
                     _loc3_.push(_loc4_);
                  }
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats == AnimationFrame.const_531)
               {
                  _loc6_ = true;
                  _loc5_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_485[param1] as AnimationFrame;
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_485[param1] as AnimationFrame;
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
