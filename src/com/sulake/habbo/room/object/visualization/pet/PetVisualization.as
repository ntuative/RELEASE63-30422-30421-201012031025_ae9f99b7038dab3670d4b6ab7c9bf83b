package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_477.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_477.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_388 = new ExperienceData(this.var_525);
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1474 = param1.getNumber(RoomObjectVariableEnum.const_431) > 0;
            this.var_1194 = param1.getString(RoomObjectVariableEnum.const_295);
            this.var_219 = param1.getString(RoomObjectVariableEnum.const_423);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_712);
            this.var_1473 = param1.getNumber(RoomObjectVariableEnum.const_319);
            this.var_1308 = param1.getNumber(RoomObjectVariableEnum.const_1044);
            this.var_1888 = param1.getNumber(RoomObjectVariableEnum.const_1015);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_175);
            if(this.var_560 != _loc3_)
            {
               this.var_560 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_413 != param1.getUpdateID() || this.var_1511 != param2.updateId)
         {
            ...
            if(_loc4_ != this.var_1477 || param3)
            {
            ...
            if(_loc5_ != this.var_1472 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_525.getAvatar(this.var_560,param1,this);
            if(_loc3_ != null)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_254 || this.var_51 == null)
         {
            if(_loc6_ != var_254)
            {
               var_254 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_879 || this.var_1074 > 0 || this.var_1659;
         this.var_388.alpha = 0;
         if(this.var_1308 > 0)
         {
            _loc12_ = param2 - this.var_1308;
            if(_loc12_ < AvatarAction.const_944)
            {
               this.var_388.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this.var_388.setExperience(this.var_1888);
               this.var_1074 = this.const_1812;
            }
            else
            {
               this.var_1308 = 0;
            ...
            if(_loc13_ != null)
            {
               ...
               {
                  _loc13_.asset = this.var_388.image;
                  _loc13_.offsetX = -20;
                  _loc13_.offsetY = -80;
                  _loc13_.alpha = this.var_388.alpha;
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_273,this.var_1194);
         }
