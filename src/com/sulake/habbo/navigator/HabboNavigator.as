package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_515:RoomInfoViewCtrl;
      
      private var var_931:RoomCreateViewCtrl;
      ...
      private var var_2647:Dictionary;
      ...
      private var var_1894:RoomThumbnailRenderer;
      
      private var var_843:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_258 = new MainViewCtrl(this);
         this.var_515 = new RoomInfoViewCtrl(this);
         this.var_931 = new RoomCreateViewCtrl(this);
         this.var_1894 = new RoomThumbnailRenderer(this);
         this.var_843 = new GuestRoomPasswordInput(this);
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(this.var_20)
         {
            ...
            this.var_515.close();
            this.var_20.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            this.var_515.close();
            this.var_20.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_277,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_515.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_258.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_258.startSearch(Tabs.const_221,Tabs.const_334,param1);
         this.var_258.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_258.startSearch(Tabs.const_271,Tabs.const_228);
         this.var_359.getTab(Tabs.const_271).tabPageDecorator.tabSelected();
      }
