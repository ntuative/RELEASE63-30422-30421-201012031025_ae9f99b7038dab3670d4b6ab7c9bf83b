package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1063:ICheckBoxWindow;
      ...
      private var var_2313:ITextWindow;
      
      private var var_2314:ITextWindow;
      
      private var var_1655:ITextWindow;
      ...
      {
         if(param1 != this.var_322 || this.var_1069 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1069 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1351)
         {
            this.var_693.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1297)
         {
            this.var_693.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1448)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1457)
         {
         ...
         {
            this.var_693.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_469,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_693,this.onDoorModePasswordUnselect);
         ...
         this.var_693 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         ...
         this.var_1062 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1063 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1066 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1067 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_585 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1656 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1306 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1070 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1065 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1654 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1305 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_234 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1068 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2313 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2314 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1655 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1655.procedure = this.onSwitchView;
         this.var_1068.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1656.visible = this._inRoom;
         this.var_1654.visible = this._inRoom;
         this.var_2314.visible = this.var_476;
         this.var_2313.visible = !this.var_476;
         if(this.var_476)
         {
            this.var_1065.visible = true;
            this.var_1305.visible = false;
            this.refreshFlatControllers();
            this.var_1065.height = Util.getLowestPoint(this.var_1065) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1070.visible = true;
            this.var_1305.visible = true;
            this.var_1306.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1306.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1070.height = Util.getLowestPoint(this.var_1070) + 4;
         }
         this.var_1655.text = !!this.var_476 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1656.name,this.var_1306.name,this.var_1070.name,this.var_1065.name,this.var_1305.name,this.var_1654.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         if(this.var_1063)
         {
            if(_loc1_.allowPets)
            {
               this.var_1063.select();
            }
            else
            {
               this.var_1063.unselect();
            }
         }
         if(this.var_1066)
         {
            ...
            {
               this.var_1066.select();
            }
            else
            {
               this.var_1066.unselect();
            }
         }
         if(this.var_1067)
         {
            ...
            {
               this.var_1067.select();
            }
            else
            {
               this.var_1067.unselect();
            }
         }
         if(this.var_585)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_693.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_493;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_109)
         {
            _loc8_ = this.var_843.getText();
            _loc9_ = this.var_1062.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_843.clearErrors();
               this.var_1062.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1063.isSelected;
         _loc2_.allowFoodConsume = this.var_1066.isSelected;
         _loc2_.allowWalkThrough = this.var_1067.isSelected;
         _loc2_.hideWalls = this.var_585.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_842,_loc2_.tags);
         this.addTag(this.var_844,_loc2_.tags);
         this.clearErrors();
         this.var_1069 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_151,HabboToolbarIconEnum.ROOMINFO));
      }
