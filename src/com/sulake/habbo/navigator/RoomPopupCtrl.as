package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_103:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_1894 = new RoomThumbnailRenderer(param1);
         this.var_1029 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_154,this.var_103);
         if(this.var_103.ownerName != "" && this.var_103.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_154,!!this.var_103.event ? this.getEventCtg(this.var_103.categoryId) : this.getRoomCtg(this.var_103.categoryId));
         this.refreshRoomDesc(this.var_154,this.var_103);
         this.refreshExtraCont();
         this.refreshInfo(this.var_154,"trading_allowed",this.var_103.allowTrading);
         this.refreshInfo(this.var_154,"doormode_doorbell",this.var_103.doorMode == 1);
         this.refreshInfo(this.var_154,"doormode_password",this.var_103.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_154,this.var_103.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1029.refreshTags(_loc1_,this.var_103.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_103.score);
         if(this.var_103.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_103.eventCreationTime);
         }
         this.var_1894.refreshThumbnail(_loc1_,this.var_103.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_221,Tabs.const_253,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
