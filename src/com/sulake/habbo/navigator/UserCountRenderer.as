package com.sulake.habbo.navigator
{
   ...
   public class UserCountRenderer
   {
      ...
      public static const const_935:String = "usercount";
      ...
      {
         var _loc7_:IWindowContainer = IWindowContainer(param2.findChildByName(const_935));
         if(_loc7_ == null)
         {
            _loc7_ = IWindowContainer(this._navigator.getXmlWindow("grs_usercount"));
            _loc7_.name = const_935;
            _loc7_.x = param5;
            _loc7_.y = param6;
         ...
         _loc8_.text = "" + param3;
         var _loc9_:String = this.method_5(param1,param3);
         this.refreshBg(_loc7_,_loc9_);
         _loc7_.visible = true;
      }
      
      private function method_5(param1:int, param2:int) : String
      {
         if(param2 == 0)
         {
            return "b";
