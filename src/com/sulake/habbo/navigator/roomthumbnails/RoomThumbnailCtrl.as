package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1976:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1460 = IButtonWindow(this.find("bg_tab"));
         this.var_1459 = IButtonWindow(this.find("top_tab"));
         this.var_1461 = IButtonWindow(this.find("obj_tab"));
         this.var_1976 = IWindowContainer(this.find("tile_grid"));
         this.var_1975 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1460,this.onBgTabButton);
         Util.setProcDirectly(this.var_1459,this.onTopTabButton);
         Util.setProcDirectly(this.var_1461,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1460,this.var_62.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1459,this.var_62.mode != ThumbnailEditorModel.const_54);
         this.setEnabled(this.var_1461,this.var_62.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_1975;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_1976;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_428)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_277,HabboWindowStyle.const_37,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
