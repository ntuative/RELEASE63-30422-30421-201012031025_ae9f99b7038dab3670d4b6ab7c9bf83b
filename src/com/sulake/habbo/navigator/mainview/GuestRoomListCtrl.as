package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_424:RoomPopupCtrl;
      
      private var var_503:IScrollbarWindow;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_424 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_503 = IScrollbarWindow(this.var_157.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         this.var_157.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.color = this.method_5(param1);
         _loc2_.tags.push(param1);
         return _loc2_;
      }
      
      private function method_5(param1:int) : uint
      {
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_182,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_166)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_424.visible && this.var_1964)
            {
               return;
            }
            ...
            this.var_424.room = _loc4_;
            this.var_424.showPopup(param2);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            param2.color = this.method_5(_loc5_);
            this.var_424.closePopup();
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1179.tags[0];
            this.var_1179.color = this.method_5(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_1965 - _loc2_.stageX);
         this.var_1965 = _loc2_.stageX;
         this.var_1964 = _loc3_ > 2;
      }
   }
}
