package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_712:TextFieldManager;
      ...
      private var var_2407:ITextWindow;
      ...
      private var var_858:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1720.visible = true;
         this.var_2407.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_712.setText(param1.eventDescription);
         this.var_842.setText(this.getTagFromEvent(param1,1));
         this.var_844.setText(this.getTagFromEvent(param1,2));
         this.var_1338.visible = false;
         this.var_1340.visible = true;
         this.var_1339.visible = true;
         this.var_1721.visible = false;
         this.var_1722.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_858.visible = true;
         this.var_1720.visible = false;
         this.var_1338.visible = true;
         this.var_1340.visible = false;
         this.var_1339.visible = false;
         this.var_712.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_842.goBackToInitialState();
         this.var_844.goBackToInitialState();
         this.var_858.selection = 0;
         this.var_1721.visible = true;
         this.var_1722.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_858.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_712.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_842.getText());
         this.addTag(_loc6_,this.var_844.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_712.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1720 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2407 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1721 = ITextWindow(this.find("create_caption"));
            this.var_1722 = ITextWindow(this.find("edit_caption"));
            this.var_1338 = IButtonWindow(this.find("create_button"));
            this.var_1340 = IButtonWindow(this.find("edit_button"));
            this.var_2408 = IButtonWindow(this.find("cancel_button"));
            this.var_1339 = IButtonWindow(this.find("end_button"));
            this.var_858 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1338,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1340,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1339,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2408,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_712 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_842 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_844 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
