package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_864:Object = {"frontpage3":[7,8]};
      
      private static const const_863:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_708.length)
         {
            _loc2_ = String(this.var_708[param1]).replace("#","0x");
