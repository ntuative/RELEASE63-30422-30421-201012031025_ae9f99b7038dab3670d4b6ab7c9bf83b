package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1724:IProductData;
      ...
      {
         super();
         this.var_1726 = param1.productType;
         this.var_1725 = param1.furniClassId;
         this.var_1341 = param1.extraParam;
         this.var_1342 = param1.productCount;
         this.var_1727 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_79:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1341);
               break;
