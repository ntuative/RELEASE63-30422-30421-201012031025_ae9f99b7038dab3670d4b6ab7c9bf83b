   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_949.add(MarketPlaceOfferState.const_1062,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_949.add(MarketPlaceOfferState.const_403,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_949.add(MarketPlaceOfferState.const_183,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         this.updateStatusDisplay(this.const_1526,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            ...
            _loc4_ = this.var_949.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_1062)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_183)
                  {
