package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_435:IItemGridWindow;
      
      private var var_1198:IScrollbarWindow;
      ...
      {
         this.var_776 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_960 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1480 = new Point(this.var_80.x,this.var_80.y);
         this.var_435 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1198 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1479 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_776.text = _loc4_;
         this.var_960.text = _loc5_;
         this.var_776.height = this.var_776.textHeight + 5;
         this.var_960.y = this.var_776.y + this.var_776.height;
         this.var_960.height = Math.max(130,this.var_960.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_393:
                  _loc6_ = this.var_1479.clone();
                  if(this.var_435 != null)
                  {
                     this.var_435.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_435,this.var_1198,this.var_1496);
                     this.var_435.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_207:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_273,AvatarAction.const_448);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1986)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_80 != null && true)
         {
            ...
            this.var_80.x = this.var_1480.x;
            this.var_80.y = this.var_1480.y;
            if(param3 != null)
            {
