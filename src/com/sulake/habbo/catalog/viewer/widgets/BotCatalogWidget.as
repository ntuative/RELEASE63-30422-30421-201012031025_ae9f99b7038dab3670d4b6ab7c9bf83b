package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      {
         super(param1);
         this.var_1163 = _window.findChildByName("botGrid") as IItemGridWindow;
         this.var_1651 = new Map();
      }
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_689,page.pageId);
      }
      
      private function onBotDefinitions(param1:RentableBotDefinitionWidgetEvent) : void
      {
         this.var_1302 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = this.var_1302.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1651.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1302.getValue(this.var_689.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_689.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_689.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_689.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1651.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1302.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_689.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
