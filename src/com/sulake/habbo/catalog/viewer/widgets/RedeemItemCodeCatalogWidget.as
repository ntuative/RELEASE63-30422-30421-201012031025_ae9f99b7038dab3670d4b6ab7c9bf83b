package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1089:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1089.removeEventListener(WindowKeyboardEvent.const_144,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         this.var_1089 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1089 != null)
         {
            this.var_1089.addEventListener(WindowKeyboardEvent.const_144,this.windowKeyEventProcessor);
         }
      }
