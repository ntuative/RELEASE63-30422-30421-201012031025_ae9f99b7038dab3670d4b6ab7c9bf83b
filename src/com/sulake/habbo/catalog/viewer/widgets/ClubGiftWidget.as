package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_207)
         {
            this.var_207 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_207)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_207.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_207.setGlobalPosition(_loc6_.subtract(new Point(this.var_207.width / 2,this.var_207.height / 2)));
