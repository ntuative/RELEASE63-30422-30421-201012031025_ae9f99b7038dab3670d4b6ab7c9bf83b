package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1519:String = "ctlg_";
       
      
      protected var var_1879:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_965:ICatalogViewer;
      ...
      private var var_1366:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1367:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1366 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1119);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1119);
      }
      ...
      {
         var _loc2_:String = const_1519 + param1;
         ...
         this.var_1879 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1879) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1367 = new ItemGridCatalogWidget(_loc1_);
            this.var_58.push(this.var_1367);
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1309) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_58.push(new ItemGroupCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1431) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1491) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1305) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1366;
            _loc2_.init();
         }
         this.var_1366.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1366.dispatchEvent(param1);
      }
   }
}
