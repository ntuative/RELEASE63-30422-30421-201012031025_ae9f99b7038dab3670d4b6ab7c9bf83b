package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_83:IPurchasableOffer;
      ...
      private var var_570:IWindowContainer;
      
      private var var_317:int = -1;
      
      private const const_1809:int = 10;
      ...
      private const const_1539:uint = 4.293848814E9;
      
      private const const_1540:uint = 4.294967295E9;
      
      private const const_1808:uint = 4.291613146E9;
      ...
      {
         if(this.var_83 == null || this.var_83.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_83.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_83.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_83 is Offer)
            {
               _loc10_ = this.var_83.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_83 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_207:
                  ...
                  break;
               case ProductTypeEnum.const_373:
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = this._catalog.getProductData(this.var_83.localizationId);
         ...
         var _loc8_:String = this.var_83.activityPointType == Purse.const_467 ? "pixels" : "activitypoints";
         switch(this.var_83.priceType)
         {
            case Offer.const_512:
               ...
               this._localization.registerParameter(_loc6_,"credits",this.var_83.priceInCredits.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_786:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits+activitypoints." + this.var_83.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,"credits",this.var_83.priceInCredits.toString());
               this._localization.registerParameter(_loc6_,_loc8_,this.var_83.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,"credits",_loc7_);
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_83.activityPointType).toString());
               _loc4_ = _loc5_.value;
               break;
            case Offer.const_766:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.activitypoints." + this.var_83.activityPointType;
               _loc5_ = this._localization.getLocalization(_loc6_);
               this._localization.registerParameter(_loc6_,_loc8_,this.var_83.priceInActivityPoints.toString());
               _loc3_ = _loc5_.value;
               this._localization.registerParameter(_loc6_,_loc8_,this._catalog.getPurse().getActivityPointsForType(this.var_83.activityPointType).toString());
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1605 = _loc1_.stuffTypes;
            this.var_678 = _loc1_.boxTypes;
            this.var_677 = _loc1_.ribbonTypes;
            this.var_1030 = this.var_1605[0];
            this.var_316 = this.var_678[0];
            this.var_315 = this.var_677[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_315 < 0)
         {
            this.var_315 = this.var_677.length - 1;
         }
         if(this.var_315 > this.var_677.length - 1)
         {
            this.var_315 = 0;
         }
         if(this.var_316 < 0)
         {
            this.var_316 = this.var_678.length - 1;
         }
         if(this.var_316 > this.var_678.length - 1)
         {
            this.var_316 = 0;
         }
         var _loc1_:int = this.var_678[this.var_316] * 1000 + this.var_677[this.var_315];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_83.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1030,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1278 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1605;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1030);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_678[this.var_316]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_677[this.var_315]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_83,this.var_1279,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_83.offerId,this.var_1279);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_111:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2246 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_199)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1809)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2246 = _loc3_.text;
               break;
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowKeyboardEvent.const_568:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_317 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_317 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_317) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_570 == null)
         {
            this.var_570 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_570.procedure = this.suggestionsEventHandler;
         }
         if(this.var_228 == null || this.var_570 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_570.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_317) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_317);
         }
         this.var_317 = param1;
         if(this.var_317 < 0)
         {
            this.var_317 = _loc2_.numListItems - 1;
         }
         if(this.var_317 >= _loc2_.numListItems)
         {
            this.var_317 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_317) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1808;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1539) : uint(this.const_1540);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1030;
               }
            }
            _loc4_++;
         }
