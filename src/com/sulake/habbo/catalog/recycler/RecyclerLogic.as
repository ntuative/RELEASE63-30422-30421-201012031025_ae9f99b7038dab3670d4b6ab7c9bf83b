package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_817:int = 0;
      ...
      {
         return this.var_520 != const_817;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1435 != RecyclerStatusMessageEvent.const_990;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_520 == const_382;
      }
      ...
      {
         this.var_520 = const_816;
         this.var_101 = new Array(const_179);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1435)
         {
            case RecyclerStatusMessageEvent.const_1384:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_990:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1053:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1469:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_101.length > 0)
         {
            oldObjectData = this.var_101[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_179)
            {
               oldObjectData = this.var_101[newSlotId];
         ...
         this.var_101[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_101[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_101[param1].id))
         {
            return;
         }
         this.var_101[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_101.length < const_179)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_101.length)
         {
            if(this.var_101[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
