package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_259:IBitmapWrapperWindow;
      ...
      {
         var _loc8_:* = null;
         this.var_259 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_259 != null && !this.var_259.disposed)
         {
            ...
            this.var_259.bitmap = new BitmapData(this.var_259.width,this.var_259.height,true,16777215);
            this.var_259.bitmap.fillRect(this.var_259.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_259.width - param1.width) / 2,(this.var_259.height - param1.height) / 2);
            this.var_259.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
