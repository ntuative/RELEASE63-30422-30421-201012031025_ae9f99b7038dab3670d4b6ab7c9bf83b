package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyConfirmationDialog
   {
      ...
      private var var_83:ClubBuyOfferData;
      ...
      {
         var _loc3_:* = null;
         if(!this.var_83 || !this._controller)
         {
            return;
         }
         ...
         _loc6_ += !!this.var_83.vip ? "vip" : "hc";
         _loc6_ += !!this.var_83.upgrade ? ".period" : "";
         ...
         var _loc11_:String = !!this.var_83.vip ? "vip" : "hc";
         var _loc12_:String = _loc2_.getLocalization("catalog.club." + _loc11_).value;
         var _loc13_:int = this.var_83.periods == 0 ? 1 : int(this.var_83.periods);
         _loc2_.registerParameter("catalog.club.buy.confirm.price","price",String(this.var_83.price));
         ...
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","day",String(this.var_83.day));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","month",String(this.var_83.month));
         _loc2_.registerParameter("catalog.club.buy.confirm.amount","year",String(this.var_83.year));
         _loc2_.registerParameter("catalog.club.buy.confirm.before","days",String(_loc10_));
         _loc2_.registerParameter("catalog.club.buy.confirm.after","days",String(this.var_83.daysLeftAfterPurchase));
         if(this.var_83.upgrade)
         {
      ...
      {
         var _loc1_:* = null;
         if(this.var_83 && this.var_83.productContainer && this.var_83.productContainer.firstProduct)
         {
            _loc1_ = this.var_83.productContainer.firstProduct.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      {
         if(!param1 || !param2 || !this._controller || !this.var_83)
         {
            return;
         }
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_83,this._pageId);
               break;
