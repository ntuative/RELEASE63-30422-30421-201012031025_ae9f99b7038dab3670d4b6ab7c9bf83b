package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1189:String = "poster";
       
      
      public const const_1754:int = 1;
      
      public const const_1594:int = 2;
      
      public const const_1837:int = 3;
      ...
      private var var_2281:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2284,this.var_2282,this.var_2283,this.var_2285);
      }
      ...
      {
         if(!this.var_156 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_156.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1754,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = this.var_204.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_204.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_403)
            {
               this.var_204.remove(_loc2_);
               _loc3_.dispose();
            }
         }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_156)
         {
            for each(_loc5_ in this.var_156)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_156.add(_loc4_.offerId,_loc6_);
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         if(this.var_204)
         {
            for each(_loc5_ in this.var_204)
            {
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
         ...
         this.var_1990 = _loc3_.creditsWaiting;
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc6_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_204.add(_loc4_.offerId,_loc6_);
         }
         if(this._visualization == null)
         {
            return;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_156.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_156.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_156.add(parser.offerId,updateItem);
            }
            this.var_156.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1594,updateItem);
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_204.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2260 || param1.furniTypeId != this.var_2259)
         {
            return;
         }
      ...
      private function isPosterItem(param1:MarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1189)
               {
                  _loc2_ = true;
               }
            }
