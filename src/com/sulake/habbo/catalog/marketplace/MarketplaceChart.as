package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_519)
            {
               this.var_519 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_519).toString().length - 1);
         this.var_519 = Math.ceil(this.var_519 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_519.toString();
         _loc3_.draw(_loc6_);
         this.var_938 = param1 - _loc6_.textWidth - 2;
         this.var_766 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_766);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_766 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_938 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_938,(param2 - this.var_766) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_938 + this.var_938 / -this.var_2607 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_766 - this.var_766 / this.var_519 * this.var_171[param1];
      }
