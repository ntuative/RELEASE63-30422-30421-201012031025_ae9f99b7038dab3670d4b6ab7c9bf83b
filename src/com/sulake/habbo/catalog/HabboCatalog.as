package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_337:CatalogViewer;
      
      private var var_338:ICatalogNavigator;
      ...
      private var var_2510:Boolean = true;
      ...
      private var var_490:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.method_8(param1.activityPointType);
            return;
         }
         if(param1 is Offer)
         {
            if(this.var_210 == null)
            {
               this.var_210 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_210.showOffer(this,param1,param2,param3,_loc4_);
         ...
         {
            this.var_490.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_338.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_112.getActivityPointsForType(Purse.const_467)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_112,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_337.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_338 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_337 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_337.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1794 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1126 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_490 == null)
         {
            this.var_490 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_338.buildCatalogIndex(_loc2_);
         if(this.var_738 && this.var_738 != "")
         {
            this.var_338.openPage(this.var_738);
            this.var_738 = "";
            this.var_891 = -1;
         }
         else if(this.var_891 > -1)
         {
            this.var_338.openPageById(this.var_891,this.var_1795);
            this.var_891 = -1;
            this.var_1795 = -1;
            this.var_738 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_337.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onNotEnoughBalance(param1:IMessageEvent) : void
      {
         ...
         {
            this.method_8(_loc3_.activityPointType);
         }
         if(this.var_210 != null)
         {
            this.var_210.notEnoughCredits();
         }
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_337.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2510 && this.var_608 != null)
         {
            this.var_608.playSound(HabboSoundTypesEnum.const_1059);
         }
         this.var_2510 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2511 && this.var_608 != null)
         {
            this.var_608.playSound(HabboSoundTypesEnum.const_975);
         }
         this.var_2511 = false;
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1126.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_337.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
