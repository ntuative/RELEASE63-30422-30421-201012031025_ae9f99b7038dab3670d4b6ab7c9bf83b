package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1217:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1353:XML;
      
      private static var var_1352:XML;
       
      
      private var var_1754:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2630:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1754 == 4294967295)
            {
               this.var_1754 = _loc1_.color;
            }
            _loc1_.color = const_1217;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1389;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1269;
            }
         }
      }
      ...
      {
         this.var_55 = navigator.catalog.windowManager.buildFromXML(var_1352) as IItemListWindow;
         if(this.var_55 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1353) as IWindowContainer;
         }
         else
         {
