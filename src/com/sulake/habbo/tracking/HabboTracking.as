package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_866:uint = 11;
      ...
      private var var_1093:IHabboWindowManager;
      ...
      private var var_238:PerformanceTracker = null;
      
      private var var_595:FramerateTracker = null;
      
      private var var_239:LatencyTracker = null;
      
      private var var_597:LagWarningLogger = null;
      
      private var var_596:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_238 = new PerformanceTracker();
         this.var_595 = new FramerateTracker();
         this.var_239 = new LatencyTracker();
         this.var_597 = new LagWarningLogger();
         this.var_596 = new ToolbarClickTracker(this);
         this.var_1335 = new Array(const_866);
         var _loc4_:int = 0;
         while(_loc4_ < const_866)
         {
            this.var_1335[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1256,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1288,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_796,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1023,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1093)
            {
               this.var_1093.release(new IIDHabboWindowManager());
               this.var_1093 = null;
            }
            if(this.var_283)
            {
            ...
            if(this.var_185)
            {
               if(!this.var_185.disposed)
               {
                  ...
                  Component(this.var_185).events.removeEventListener(HabboFriendListTrackingEvent.const_327,this.onFriendlistTrackingEvent);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_161)
         {
            if(this.var_239 != null)
            {
               this.var_239.configuration = this.var_161;
            }
            if(this.var_238 != null)
            {
               this.var_238.configuration = this.var_161;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1261);
            if(this.var_161)
            {
               if(this.var_597 != null)
               {
                  this.var_597.configure(this.var_161);
               }
               if(this.var_595 != null)
               {
                  this.var_595.configure(this.var_161);
               }
               if(this.var_596 != null)
               {
                  this.var_596.configure(this.var_161);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_720,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_664,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_239 != null)
            {
               this.var_239.communication = this._communication;
               this.var_239.connection = param1;
            }
            if(this.var_597 != null)
            {
               this.var_597.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1252);
         }
         else if(param1.type == HabboHotelViewEvent.const_517)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1374);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1489);
               break;
            case HabboCommunicationEvent.const_720:
               this.trackLoginStep(HabboLoginTrackingStep.const_1501,String(this._communication.port));
               break;
      ...
      {
         this.var_1093 = IHabboWindowManager(param2);
         if(this.var_1093)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_161)
            {
               if(this.var_161.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1335)
                  {
                  ...
                  if(this.var_238 != null)
                  {
                     _loc4_["null"] = this.var_238.flashVersion;
                     _loc4_["null"] = this.var_238.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_937);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_937,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_185).events.addEventListener(HabboFriendListTrackingEvent.const_327,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_327:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2397)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1405);
            this.var_2397 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1023,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_796,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_298,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_283 = param2 as IAdManager;
         this.var_283.events.addEventListener(AdEvent.const_529,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_596)
         {
            this.var_596.track(param1.iconName);
         }
      }
      ...
      {
         this.var_597.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_1094 > -1 && _loc2_ < this.var_1094)
         {
            ++this.var_1713;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1713);
         }
         if(this.var_1094 > -1 && _loc2_ - this.var_1094 > 15000)
         {
            ++this.var_1712;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1712);
         }
         this.var_1094 = _loc2_;
         if(this.var_238 != null)
         {
         ...
         if(this.var_239 != null)
         {
            this.var_239.update(param1);
         }
         if(this.var_595 != null)
         {
            this.var_595.trackUpdate(param1,this);
         }
         if(this.var_597 != null)
         {
            this.var_597.update();
