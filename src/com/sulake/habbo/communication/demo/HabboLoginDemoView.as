package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_427:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_153.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_132,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1525,"/");
         if(_loc5_ != null)
         {
         ...
         {
            if(this.var_153.habboConfiguration.getKey("use.sso","false") == "true")
            {
               _loc8_.select();
            }
         }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1525,"/");
         ...
         {
            dispatchEvent(new Event(const_427));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_152.removeEventListener(SSOTicket.const_328,this.onParsedTicketSuccess);
            this.var_152.removeEventListener(SSOTicket.const_285,this.onParsedTicketFailure);
            this.var_152 = null;
         }
         var _loc1_:String = "";
         ...
         this.var_152 = new SSOTicket(this.var_153.assets,_loc2_,_loc1_);
         this.var_152.addEventListener(SSOTicket.const_328,this.onParsedTicketSuccess);
         this.var_152.addEventListener(SSOTicket.const_285,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_152.ticket);
         this.var_153.shockwaveClientUrl = this.var_152.shockwaveClientUrl;
         this.var_153.ssoTicket = this.var_152.ticket;
         this.var_152.removeEventListener(SSOTicket.const_328,this.onParsedTicketSuccess);
         this.var_152.removeEventListener(SSOTicket.const_285,this.onParsedTicketFailure);
         this.var_152 = null;
         dispatchEvent(new Event(const_427));
