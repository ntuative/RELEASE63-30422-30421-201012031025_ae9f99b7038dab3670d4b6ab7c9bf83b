package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_1859:Boolean;
      
      protected var var_1856:Boolean;
      
      protected var var_1925:String;
      
      protected var var_1858:Boolean;
      
      protected var var_1860:Boolean;
      
      protected var var_1857:Boolean;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_1859 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_1856 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
                  this.var_1858 = _loc5_ > 0;
                  break;
               case 3:
                  _loc5_ = param1.readInteger();
