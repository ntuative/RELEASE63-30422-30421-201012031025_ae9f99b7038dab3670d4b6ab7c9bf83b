package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_213 = IFrameWindow(this.var_68.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_213.findChildByName("description").caption = this.var_68.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_213.findChildByName("reward.currency.desc").caption = this.var_68.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
