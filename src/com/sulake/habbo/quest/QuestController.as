package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      {
         return this.var_296 != null && this.var_296.isVisible();
      }
      ...
      {
         var _loc3_:QuestCampaign = this.var_642[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:QuestCampaign = this.var_642[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1,param2);
            this.var_642[param1] = _loc4_;
         }
         this.var_296 = _loc4_;
