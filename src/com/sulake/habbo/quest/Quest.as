package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1751:Date;
      
      private var _localizationCode:String;
      
      private var var_175:Boolean = false;
      
      private var var_2445:uint = 2;
      
      private var var_2444:uint = 0;
      
      private var var_831:IWindow;
      ...
      {
         this.var_349 = param1.status;
         this._type = param1.type;
         this.var_1545 = param1.roomItemTypeName;
         this.var_1547 = param1.rewardCurrencyAmount;
         this.var_1751 = new Date();
         this.var_1751.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_175)
            {
               this.var_831.style = this.var_2444;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_175)
            {
               this.var_831.style = this.var_2445;
            }
         }
      }
